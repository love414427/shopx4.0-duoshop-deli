<?php /*a:13:{s:70:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/category/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/header.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/header_style_root.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/page_loading.html";i:1699863362;s:66:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/nav.html";i:1699863362;s:77:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/header_top_nav.html";i:1699863362;s:73:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/nav_search.html";i:1699863362;s:73:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/header_nav.html";i:1699863362;s:77:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/goods_category.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/not_data.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/footer.html";i:1699863362;s:73:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/footer_nav.html";i:1699863362;s:76:"/www/wwwroot/v4.shop.iun.cc/app/index/view/default/public/footer_filing.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-container category-list-container am-radius">
    <?php if(!empty($goods_category_list)): if($category_level == 0): ?>
            <div class="am-container zero-search" data-url="<?php echo MyUrl('index/category/datalist'); ?>" data-all-name="<?php echo MyLang('all_title'); ?>">
                <div class="zero-search-top">
                    <div class="am-avg-sm-12 am-avg-md-12 am-avg-lg-12 zero-title am-radius am-scrollable-horizontal" data-am-sticky>
                        <div class="am-slider am-slider-default am-slider-carousel title-slider" data-am-flexslider="{itemWidth: <?php if(IsMobile()): ?>80<?php else: ?>108<?php endif; ?>, itemMargin: 0, slideshow: false,controlNav:false}">
                            <!-- 第一级菜单 -->
                            <ul class="am-slides am-text-nowrap">
                                <?php foreach($goods_category_list as $k=>$v): ?>
                                    <li class="am-text-truncate <?php if($k == 0): ?> active<?php endif; ?>" data-id="<?php echo htmlentities($v['id']); ?>" data-json="<?php if(!empty($v['items'])): ?><?php echo urlencode(base64_encode(json_encode($v['items']))); ?><?php endif; ?>">
                                        <div class="zero-item">
                                            <?php if(!empty($v['icon'])): ?>
                                                <a style="background-image: url(<?php if(empty($v['realistic_images'])): ?><?php echo htmlentities($v['icon']); else: ?><?php echo htmlentities($v['realistic_images']); ?><?php endif; ?>)" alt="<?php echo htmlentities($v['name']); ?>"></a>
                                            <?php endif; ?>
                ...
                <?php if(count(array_filter(array_column($goods_category_list, 'items'))) > 0): ?>
                    <div class="zero-search-left">
                        <div class="zero-left am-radius" data-am-sticky="{top:130}"> 
                            <!-- 第二级菜单 -->
                            <ul class="category-nav">
                                <?php if(!empty($goods_category_list[0]) and !empty($goods_category_list[0]['items'])): ?>
                                    <li class="am-text-break active" data-id=""><?php echo MyLang('all_title'); ?></li>
                                    <?php foreach($goods_category_list[0]['items'] as $v): ?>
                                        <li class="am-text-break" data-json="<?php if(!empty($v['items'])): ?><?php echo urlencode(base64_encode(json_encode($v['items']))); ?><?php endif; ?>" data-id="<?php echo htmlentities($v['id']); ?>"><?php echo htmlentities($v['name']); ?></li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
                        </div>
                ...
                <?php endif; ?>
                <div class="zero-search-right <?php if(count(array_filter(array_column($goods_category_list, 'items'))) == 0): ?>category-one-subset-content<?php endif; ?>">
                ...
                <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-5">
                    ...
                    <li class="am-fl">
                        <div class="item-content am-text-center am-margin-lg">
                            <a href="<?php echo MyUrl('index/search/index', ['cid'=>$v['id']]); ?>" class="am-block">
                                <?php if(!empty($v['realistic_images'])): ?>
                                    <img src="<?php echo htmlentities($v['realistic_images']); ?>" alt="<?php echo htmlentities($v['name']); ?>" class="category-icon am-block am-radius am-images-scale" />
                                <?php elseif(!empty($v['icon'])): ?>
                                    <img src="<?php echo htmlentities($v['icon']); ?>" alt="<?php echo htmlentities($v['name']); ?>" class="category-icon am-block am-radius am-images-scale am-margin-bottom-xs category-img" />
                                    <?php if(!empty($v['icon_active'])): ?>
                                        <img src="<?php echo htmlentities($v['icon_active']); ?>" alt="<?php echo htmlentities($v['name']); ?>" class="category-icon am-block am-radius am-images-scale am-margin-bottom-xs category-img-active am-hide" />
                                    <?php endif; ?>
                                <?php endif; ?>
                                <p><?php echo htmlentities($v['name']); ?></p>
                            </a>
                ...
                <div class="category-content category-content-<?php echo htmlentities($k); ?> am-fr am-padding-vertical-xs <?php if($k != 0): ?> none<?php endif; ?>">
                    <?php if(!empty($v['vice_name']) or !empty($v['describe'])): ?>
                        <div class="category-item one-cetegory">
                            <a href="<?php echo MyUrl('index/search/index', ['cid'=>$v['id']]); ?>">
                                <div class="am-flex am-flex-warp">
                                    <?php if(!empty($v['vice_name'])): ?>
                                        <span <?php if(!empty($v['bg_color'])): ?>style="color:<?php echo htmlentities($v['bg_color']); ?>;"<?php endif; ?>><?php echo htmlentities($v['vice_name']); ?></span>
                    ...
                    <?php endif; if(!empty($v['items'])): if($category_level == 2): ?>
                            <div class="category-item two-content">
                                <ul>
                                    <?php foreach($v['items'] as $vs): ?>
                                        <li class="am-fl am-text-center">
                                            <?php if(!empty($vs['icon'])): ?>
                                                <a href="<?php echo MyUrl('index/search/index', ['cid'=>$vs['id']]); ?>" class="am-block">
                                                    <img src="<?php echo htmlentities($vs['icon']); ?>" alt="<?php echo htmlentities($vs['name']); ?>" class="category-icon am-block am-margin-bottom-xs" />
                                                </a>
                                            <?php endif; ?>
                                            <p>
                                                <a href="<?php echo MyUrl('index/search/index', ['cid'=>$vs['id']]); ?>" class="am-block"><?php echo htmlentities($vs['name']); ?></a>
                                            </p>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        <?php elseif($category_level == 3): foreach($v['items'] as $vs): ?>
                                    ...
                                    <?php if(!empty($vs['items'])): ?>
                                        <ul>
                                            <?php foreach($vs['items'] as $kss=>$vss): ?>
                                                <li class="am-fl am-text-center">
                                                    <p>
                                                        <a href="<?php echo MyUrl('index/search/index', ['cid'=>$vss['id']]); ?>" class="am-block"><?php echo htmlentities($vss['name']); ?></a>
                                                    </p>
                                                </li>
                                            <?php endforeach; ?>
                                        </ul>
                        ...
                        <div class="table-no">
                            ...
                            <span><?php echo MyLang('category.no_sub_category_data_tips'); ?></span>
                            <p class="am-margin-top-lg am-text-center am-text-grey">
                                <a href="<?php echo MyUrl('index/search/index', ['cid'=>$v['id']]); ?>" class="am-text-secondary"><?php echo MyLang('category.view_category_sub_goods_name'); ?> >></a>
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="table-no">
            ...
            <p><?php echo MyLang('category.no_category_data_tips'); ?></p>
        </div>
    <?php endif; ?>
</div>
