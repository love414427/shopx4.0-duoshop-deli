...
<div class="am-g tips-error">
    <div class="am-u-md-6 am-u-sm-centered am-text-center">
        ...
        <div class="tips-nav">
            <?php if(!isset($is_to_home) or $is_to_home == 1): ?>
                <a href="<?php echo htmlentities($home_url); ?>" class="am-btn am-btn-warning am-btn-xs am-radius"><?php echo MyLang('common.back_to_the_home_title'); ?></a>
            <?php endif; if(!empty($to_url) and !empty($to_title)): ?>
                <a href="<?php echo htmlentities($to_url); ?>" class="am-btn am-btn-primary am-btn-xs am-radius"><?php echo htmlentities($to_title); ?></a>
            <?php endif; ?>
        </div>
    </div>
</div>
