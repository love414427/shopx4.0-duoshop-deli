<?php /*a:5:{s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/extends/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'extends']); ?>" enctype="multipart/form-data">
            <!-- 定时脚本配置 -->
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_crontab_config_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-alert am-alert-warning am-margin-top-xs" data-am-alert>
                        <button type="button" class="am-close">&times;</button>
                        <p><?php echo MyLang('site.extends_crontab_tips'); ?></p>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-input-group am-input-group-sm">
                            ...
                            <span class="am-input-group-label am-radius"><?php echo MyLang('minute_title'); ?></span>
                        </div>
                        <div class="am-alert">
