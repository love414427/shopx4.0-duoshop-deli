<?php /*a:17:{s:72:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/navigation/index.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:70:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/navigation/nav.html";i:1699863362;s:86:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_top.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_search.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_content.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:89:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_bottom.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_fields_select.html";i:1699863362;s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_page.html";i:1699863362;s:64:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/sort.html";i:1699863362;s:67:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_show.html";i:1699863362;s:78:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_new_window_open.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-form-table-data-container content-right">
	...
	<?php if(!empty($nav_data) and is_array($nav_data)): ?>
	<ul class="am-nav am-nav-pills table-nav second-nav">
		<?php foreach($nav_data as $v): ?>
			<li <?php if($nav_type == $v['type']): ?>class="am-active"<?php endif; ?> data-type="<?php echo htmlentities($v['type']); ?>">
				<a href="<?php echo MyUrl('admin/navigation/index', ['nav_type'=>$v['type']]); ?>"><?php echo htmlentities($v['name']); ?></a>
			</li>
		<?php endforeach; ?>
	</ul>
<?php endif; ?>
	...
	<div class="am-dropdown am-margin-right-sm" data-am-dropdown>
		<button type="button" class="am-btn am-btn-secondary am-radius am-btn-xs am-dropdown-toggle" data-am-dropdown-toggle><?php echo MyLang('add_title'); ?> <span class="am-icon-caret-down"></span></button>
		<ul class="am-dropdown-content">
            <?php foreach($add_type_list as $k=>$v): ?>
    			<li>
                    <a href="javascript:;" class="am-padding-0">
        				<button type="button" class="am-btn am-btn-link am-btn-xs am-btn-block am-text-left am-padding-horizontal-sm am-icon-plus submit-add" data-am-modal="{target: '#nav-<?php echo htmlentities($k); ?>-save-win'}" data-tag="nav-<?php echo htmlentities($k); ?>-save-win"> <?php echo htmlentities($v); ?></button>
                    </a>
    			</li>
            <?php endforeach; ?>
		</ul>
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_1853322660__=0;$__FOR_END_1853322660__=count($form_table_data_list);for($i=$__FOR_START_1853322660__;$i < $__FOR_END_1853322660__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_2107533392__=1;$__FOR_END_2107533392__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_2107533392__;$star_i <= $__FOR_END_2107533392__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
    ...
    <div class="am-popup am-radius" id="nav-custom-save-win">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title" data-add-title="<?php echo htmlentities($add_type_list['custom']); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo htmlentities($add_type_list['custom']); ?><?php echo MyLang('edit_title'); ?>"><?php echo htmlentities($add_type_list['custom']); ?><?php echo MyLang('add_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <!-- form start -->
                <form class="am-form form-validation-custom am-form-popup-fixed" action="<?php echo MyUrl('admin/navigation/save'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_pid'); ?></label>
                        <select class="am-radius chosen-select" name="pid" data-placeholder="<?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_pid_message'); ?>">
                            <option value=""><?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
                        <input type="text" placeholder="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" name="name" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" class="am-radius" required />
                    </div>
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_url'); ?><span class="am-form-group-label-tips-must">*</span></label>
                        <input type="url" placeholder="<?php echo MyLang('common_service.navigation.form_item_url_placeholder'); ?>" name="url" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_url_message'); ?>" class="am-radius" required />
                    </div>
                    <!-- 排序 开始 -->
<div class="am-form-group">
...
<!-- 排序 结束 -->
                    <!-- 是否显示 开始 -->
<div class="am-form-group">
	<label class="am-block"><?php echo MyLang('form_is_show_title'); ?></label>
	<input name="is_show" value="1" type="checkbox" data-off-text="<?php echo MyLang('no_title'); ?>" data-on-text="<?php echo MyLang('yes_title'); ?>" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if((isset($data['is_show']) and $data['is_show'] == 1) or !isset($data['is_show'])): ?>checked="true"<?php endif; ?> />
</div>
<!-- 是否显示 结束 -->
                    <!-- 是否新窗口打开 开始 -->
<div class="am-form-group">
	<label class="am-block"><?php echo MyLang('form_is_new_window_open_title'); ?></label>
	<input name="is_new_window_open" value="1" type="checkbox" data-off-text="<?php echo MyLang('no_title'); ?>" data-on-text="<?php echo MyLang('yes_title'); ?>" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if((isset($data['is_new_window_open']) and $data['is_new_window_open'] == 1) or !isset($data['is_new_window_open'])): ?>checked="true"<?php endif; ?> />
</div>
<!-- 是否新窗口打开 结束 -->
                    <div class="am-form-popup-submit">
    ...
    <div class="am-popup am-radius" id="nav-article-save-win">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title" data-add-title="<?php echo htmlentities($add_type_list['article']); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo htmlentities($add_type_list['article']); ?><?php echo MyLang('edit_title'); ?>"><?php echo htmlentities($add_type_list['article']); ?><?php echo MyLang('add_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <!-- form start -->
                <form class="am-form form-validation-article am-form-popup-fixed" action="<?php echo MyUrl('admin/navigation/save'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_pid'); ?></label>
                        <select class="am-radius chosen-select" name="pid" data-placeholder="<?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_pid_message'); ?>">
                            <option value=""><?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($add_type_list['article']); ?><span class="am-form-group-label-tips-must">*</span></label>
                        <select class="am-radius chosen-select" name="value" data-placeholder="<?php echo MyLang('please_select_tips'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_value_article_message'); ?>" required>
                    ...
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_name'); ?><span class="am-form-group-label-tips"><?php echo MyLang('common_service.navigation.form_item_name_tips', ['type'=>$add_type_list['article']]); ?></span></label>
                        <input type="text" placeholder="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" name="name" maxlength="16" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" class="am-radius" />
                    </div>
                    <!-- 排序 开始 -->
<div class="am-form-group">
    <label><?php echo MyLang('form_sort_title'); ?><span class="am-form-group-label-tips"><?php echo MyLang('form_sort_tips'); ?></span></label>
...
<!-- 是否新窗口打开 结束 -->
    ...
    <div class="am-popup am-radius" id="nav-customview-save-win">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title" data-add-title="<?php echo htmlentities($add_type_list['customview']); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo htmlentities($add_type_list['customview']); ?><?php echo MyLang('edit_title'); ?>"><?php echo htmlentities($add_type_list['customview']); ?><?php echo MyLang('add_title'); ?></h4>
                <span data-am-modal-close
                class="am-close">&times;</span>
                </div>
            <div class="am-popup-bd">
                <!-- form start -->
                <form class="am-form form-validation-customview am-form-popup-fixed" action="<?php echo MyUrl('admin/navigation/save'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_pid'); ?></label>
                        <select class="am-radius chosen-select" name="pid" data-placeholder="<?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_pid_message'); ?>">
                            <option value=""><?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($add_type_list['customview']); ?><span class="am-form-group-label-tips-must">*</span></label>
                        <select class="am-radius chosen-select" name="value" data-placeholder="<?php echo MyLang('please_select_tips'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_value_customview_message'); ?>" required>
                            <option value=""><?php echo MyLang('please_select_tips'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_name'); ?><span class="am-form-group-label-tips"><?php echo MyLang('common_service.navigation.form_item_name_tips', ['type'=>$add_type_list['customview']]); ?></span></label>
                        <input type="text" placeholder="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" name="name" maxlength="16" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" class="am-radius" />
                    </div>
                    <!-- 排序 开始 -->
<div class="am-form-group">
...
<!-- 是否新窗口打开 结束 -->
    ...
    <div class="am-popup am-radius" id="nav-goods_category-save-win">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title" data-add-title="<?php echo htmlentities($add_type_list['goods_category']); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo htmlentities($add_type_list['goods_category']); ?><?php echo MyLang('edit_title'); ?>"><?php echo htmlentities($add_type_list['goods_category']); ?><?php echo MyLang('add_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <!-- form start -->
                <form class="am-form form-validation-goods_category am-form-popup-fixed" action="<?php echo MyUrl('admin/navigation/save'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_pid'); ?></label>
                        <select class="am-radius chosen-select" name="pid" data-placeholder="<?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_pid_message'); ?>">
                            <option value=""><?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($add_type_list['goods_category']); ?><span class="am-form-group-label-tips-must">*</span></label>
                        <select class="am-radius chosen-select" name="value" data-placeholder="<?php echo MyLang('please_select_tips'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_value_goods_category_message'); ?>" required>
                            <option value=""><?php echo MyLang('please_select_tips'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_name'); ?><span class="am-form-group-label-tips"><?php echo MyLang('common_service.navigation.form_item_name_tips', ['type'=>$add_type_list['goods_category']]); ?></span></label>
                        <input type="text" placeholder="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" name="name" maxlength="16" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" class="am-radius" />
                    </div>
                    <!-- 排序 开始 -->
<div class="am-form-group">
...
<!-- 是否新窗口打开 结束 -->
    ...
    <div class="am-popup am-radius" id="nav-design-save-win">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title" data-add-title="<?php echo htmlentities($add_type_list['design']); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo htmlentities($add_type_list['design']); ?><?php echo MyLang('edit_title'); ?>"><?php echo htmlentities($add_type_list['design']); ?><?php echo MyLang('add_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <!-- form start -->
                <form class="am-form form-validation-design am-form-popup-fixed" action="<?php echo MyUrl('admin/navigation/save'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_pid'); ?></label>
                        <select class="am-radius chosen-select" name="pid" data-placeholder="<?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_pid_message'); ?>">
                            <option value=""><?php echo MyLang('common_service.navigation.form_item_pid_placeholder'); ?></option>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($add_type_list['design']); ?><span class="am-form-group-label-tips-must">*</span></label>
                        <select class="am-radius chosen-select" name="value" data-placeholder="<?php echo MyLang('please_select_tips'); ?>" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_value_design_message'); ?>" required>
                            <option value=""><?php echo MyLang('please_select_tips'); ?></option>
                            <?php foreach($design_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>"><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo MyLang('common_service.navigation.form_item_name'); ?><span class="am-form-group-label-tips"><?php echo MyLang('common_service.navigation.form_item_name_tips', ['type'=>$add_type_list['design']]); ?></span></label>
                        <input type="text" placeholder="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" name="name" maxlength="16" data-validation-message="<?php echo MyLang('common_service.navigation.form_item_name_message'); ?>" class="am-radius" />
                    </div>
                    <!-- 排序 开始 -->
<div class="am-form-group">
