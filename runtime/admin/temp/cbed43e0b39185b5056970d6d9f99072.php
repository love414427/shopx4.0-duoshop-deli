<?php /*a:5:{s:76:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/forgetpwd/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'forgetpwd']); ?>" enctype="multipart/form-data">
            <!-- 图片1 -->
            <div class="am-panel am-panel-default am-radius">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_forgetpwd_ad1_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_forgetpwd_ad1_images']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_user_forgetpwd_ad1_images-images-view" data-form-name="home_site_user_forgetpwd_ad1_images" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_user_forgetpwd_ad1_images']['value'])): ?>
                                <li>
                                    ...
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_forgetpwd_ad1_images']['value']); ?>" />
                                    <i>×</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_forgetpwd_ad1_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
                    </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_forgetpwd_ad2_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_forgetpwd_ad2_images']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_user_forgetpwd_ad2_images-images-view" data-form-name="home_site_user_forgetpwd_ad2_images" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_user_forgetpwd_ad2_images']['value'])): ?>
                                <li>
                                    ...
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_forgetpwd_ad2_images']['value']); ?>" />
                                    <i>×</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_forgetpwd_ad2_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
                    </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_forgetpwd_ad3_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_forgetpwd_ad3_images']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_user_forgetpwd_ad3_images-images-view" data-form-name="home_site_user_forgetpwd_ad3_images" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_user_forgetpwd_ad3_images']['value'])): ?>
                                <li>
                                    ...
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_forgetpwd_ad3_images']['value']); ?>" />
                                    <i>×</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_forgetpwd_ad3_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
                    </div>
