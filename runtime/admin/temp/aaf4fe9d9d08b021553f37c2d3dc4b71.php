<?php /*a:5:{s:72:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/cache/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'cache']); ?>" enctype="multipart/form-data">
            <?php if(is_array(MyLang('site.site_cache_tips_list'))): ?>
                <div class="am-alert am-alert-warning" data-am-alert>
                    <button type="button" class="am-close">&times;</button>
                    <p><?php echo implode('</p><p>', MyLang('site.site_cache_tips_list')); ?></p>
                </div>
            <?php endif; ?>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_session_cache_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_session_is_use_cache']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_session_is_use_cache']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_session_is_use_cache']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_session_is_use_cache']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_session_is_use_cache']['value']) and $data['common_session_is_use_cache']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cache_session_redis_prefix']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cache_session_redis_prefix']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_cache_session_redis_prefix']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cache_session_redis_prefix']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cache_session_redis_prefix']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cache_session_redis_prefix']['value']); ?>"<?php endif; ?> />
                    </div>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_data_cache_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_data_is_use_cache']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_data_is_use_cache']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_data_is_use_cache']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_data_is_use_cache']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_data_is_use_cache']['value']) and $data['common_data_is_use_cache']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cache_data_redis_prefix']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cache_data_redis_prefix']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_cache_data_redis_prefix']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cache_data_redis_prefix']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cache_data_redis_prefix']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cache_data_redis_prefix']['value']); ?>"<?php endif; ?> />
                    </div>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_redis_cache_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_data_is_use_redis_cache']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_data_is_use_redis_cache']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_data_is_use_redis_cache']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_data_is_use_redis_cache']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_data_is_use_redis_cache']['value']) and $data['common_data_is_use_redis_cache']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cache_data_redis_host']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cache_data_redis_host']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_cache_data_redis_host']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cache_data_redis_host']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cache_data_redis_host']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cache_data_redis_host']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cache_data_redis_port']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cache_data_redis_port']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_cache_data_redis_port']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cache_data_redis_port']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cache_data_redis_port']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cache_data_redis_port']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cache_data_redis_password']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cache_data_redis_password']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_cache_data_redis_password']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cache_data_redis_password']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cache_data_redis_password']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cache_data_redis_password']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cache_data_redis_expire']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cache_data_redis_expire']['describe']); ?></span></label>
                        <div class="am-input-group am-input-group-sm">
                            <input type="number" min="0" name="<?php echo htmlentities($data['common_cache_data_redis_expire']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cache_data_redis_expire']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_cache_data_redis_expire']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cache_data_redis_expire']['value']); ?>"<?php endif; ?> />
                            <span class="am-input-group-label am-radius"><?php echo MyLang('second_title'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
