        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				<div class="am-popup-hd">
					<h4 class="am-popup-title" data-add-title="<?php echo MyLang('brandcategory.base_nav_title'); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo MyLang('brandcategory.base_nav_title'); ?><?php echo MyLang('edit_title'); ?>"><?php echo MyLang('brandcategory.base_nav_title'); ?><?php echo MyLang('add_title'); ?></h4>
					<span data-am-modal-close class="am-close">&times;</span>
				</div>
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/brandcategory/save'); ?>" method="POST" request-type="ajax-fun" request-value="TreeFormSaveBack">
						<div class="am-form-group am-form-file">
							<label class="am-block"><?php echo MyLang('common_service.brandcategory.form_item_icon'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('common_service.brandcategory.form_item_icon_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
							...
							<div class="plug-file-upload-submit" data-view-tag="ul.brand-category-icon-images-view">+ <?php echo MyLang('form_upload_images_title'); ?></div>
						</div>
						<div class="am-form-group">
							<label><?php echo MyLang('common_service.brandcategory.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
							<input type="text" placeholder="<?php echo MyLang('common_service.brandcategory.form_item_name_message'); ?>" name="name" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('common_service.brandcategory.form_item_name_message'); ?>" class="am-radius" required />
						</div>
						<!-- 排序 开始 -->
<div class="am-form-group">
...
<!-- 是否启用 结束 -->
        ...
        <!-- list start -->
		<div id="tree" class="am-margin-top-sm" data-additional='[{"field":"icon", "value":"", "type":"input"}, {"field":"icon", "value":"<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg", "type":"attr", "tag":"ul.brand-category-icon-images-view li img", "style":"src"}]' data-node-url="<?php echo MyUrl('admin/brandcategory/getnodeson'); ?>" data-del-url="<?php echo MyUrl('admin/brandcategory/delete'); ?>" data-popup-tag="#data-save-win">
