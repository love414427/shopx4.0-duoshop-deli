<?php /*a:5:{s:73:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/verify/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'verify']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['common_verify_expire_time']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_verify_expire_time']['describe']); ?></span></label>
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" name="<?php echo htmlentities($data['common_verify_expire_time']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_verify_expire_time']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_verify_expire_time']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_verify_expire_time']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius"><?php echo MyLang('second_title'); ?></span>
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['common_verify_interval_time']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_verify_interval_time']['describe']); ?></span></label>
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" name="<?php echo htmlentities($data['common_verify_interval_time']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_verify_interval_time']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_verify_interval_time']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_verify_interval_time']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius"><?php echo MyLang('second_title'); ?></span>
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['common_img_verify_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_img_verify_state']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['common_img_verify_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_img_verify_state']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_img_verify_state']['value']) and $data['common_img_verify_state']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['common_images_verify_rules']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_images_verify_rules']['describe']); ?></span></label>
                <?php foreach($common_site_images_verify_rules_list as $v): ?>
                    <label class="am-checkbox-inline">
                        <input type="checkbox" name="<?php echo htmlentities($data['common_images_verify_rules']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_images_verify_rules']['value']) and in_array($v['value'], $data['common_images_verify_rules']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['common_images_verify_rules']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                    </label>
                <?php endforeach; ?>
            </div>
