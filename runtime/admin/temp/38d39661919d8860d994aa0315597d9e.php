<?php /*a:5:{s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/appconfig/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/appconfig/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="content">
		...
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/appconfig/save', ['nav_type'=>$nav_type]); ?>" method="POST" request-type="ajax-reload">
			<div class="am-form-group">
                <label><?php echo htmlentities($data['common_app_h5_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_h5_url']['describe']); ?></span></label>
                <input type="text" name="<?php echo htmlentities($data['common_app_h5_url']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_app_h5_url']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_app_h5_url']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_app_h5_url']['value']); ?>"<?php endif; ?> />
            </div>
			<div class="am-form-group">
                <label><?php echo htmlentities($data['common_is_mobile_concise_model']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_is_mobile_concise_model']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['common_is_mobile_concise_model']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_is_mobile_concise_model']['error_tips']); ?>" required>
                    <?php foreach(MyConst('common_is_text_list') as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_is_mobile_concise_model']['value']) and $data['common_is_mobile_concise_model']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_app_customer_service_tel']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_customer_service_tel']['describe']); ?></span></label>
