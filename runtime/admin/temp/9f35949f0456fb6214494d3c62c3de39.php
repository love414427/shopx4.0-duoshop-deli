<?php /*a:7:{s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/slide/save_info.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:79:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/event_value_tips.html";i:1699863362;s:64:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/sort.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/slide/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/slide/index', $params); ?>" enctype="multipart/form-data">
			<legend>
				<span class="am-text-default"><?php echo MyLang('slide.base_nav_title'); if(empty($data['id'])): ?><?php echo MyLang('created_title'); else: ?><?php echo MyLang('edit_title'); ?><?php endif; ?></span>
				<a href="<?php echo MyUrl('admin/slide/index', $params); ?>" class="am-fr am-text-sm am-margin-top-sm am-icon-mail-reply"> <?php echo MyLang('retreat_title'); ?></a>
			</legend>

			<div class="am-cf">
        		<div class="am-u-sm-6 am-padding-horizontal-0">
        			<div class="am-form-group">
						<label><?php echo MyLang('common_service.slide.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
						<input type="text" name="name" placeholder="<?php echo MyLang('common_service.slide.form_item_name_message'); ?>" minlength="2" maxlength="60" data-validation-message="<?php echo MyLang('common_service.slide.form_item_name_message'); ?>" class="am-radius" <?php if(!empty($data['name'])): ?> value="<?php echo htmlentities($data['name']); ?>"<?php endif; ?> required />
					</div>
        		</div>
        		<div class="am-u-sm-6 am-padding-horizontal-0">
        			<div class="am-form-group">
						<label><?php echo MyLang('form_platform_title'); ?><span class="am-form-group-label-tips-must">*</span></label>
						<select name="platform" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('optional_tips'); ?>" data-validation-message="<?php echo MyLang('form_platform_message'); ?>" required>
							<option value=""><?php echo MyLang('optional_tips'); ?></option>
							<?php foreach(MyConst('common_platform_type') as $v): ?>
								<option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['platform']) and $data['platform'] == $v['value']): ?>selected<?php else: if(!isset($data['platform']) and isset($v['checked']) and $v['checked'] == true): ?>selected<?php endif; ?><?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
        		</div>
        	...
        	<div class="am-cf">
        		<div class="am-u-sm-12 am-u-md-6 am-padding-horizontal-0">
        			<div class="am-form-group">
                        <label><?php echo MyLang('common_service.slide.form_item_describe'); ?></label>
                        <input type="text" name="describe" placeholder="<?php echo MyLang('common_service.slide.form_item_describe_message'); ?>" maxlength="230" data-validation-message="<?php echo MyLang('common_service.slide.form_item_describe_message'); ?>" class="am-radius" <?php if(!empty($data['describe'])): ?> value="<?php echo htmlentities($data['describe']); ?>"<?php endif; ?> />
                    </div>
        		</div>
        		<div class="am-u-sm-12 am-u-md-6 am-padding-horizontal-0">
                    <div class="am-cf">
                        <div class="am-u-sm-6 am-padding-horizontal-0">
                            <div class="am-form-group">
                                <label><?php echo MyLang('form_event_type_title'); ?></label>
                                <select name="event_type" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('optional_tips'); ?>" data-validation-message="<?php echo MyLang('form_event_type_message'); ?>">
                                    <option value=""><?php echo MyLang('optional_tips'); ?></option>
                                    <?php foreach(MyConst('common_app_event_type') as $v): ?>
                                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['event_type']) and $data['event_type'] == $v['value']): ?>selected<?php else: if(!isset($data['event_type']) and isset($v['checked']) and $v['checked'] == true): ?>selected<?php endif; ?><?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="am-u-sm-6 am-padding-horizontal-0">
                            <div class="am-form-group">
                                ...
                                <input type="hidden" name="bg_color" value="<?php if(!empty($data['bg_color'])): ?><?php echo htmlentities($data['bg_color']); ?><?php endif; ?>" />
                                <button class="am-btn am-btn-default am-btn-xs colorpicker-submit bg-color-tag am-btn-block bk-cr-white t-r" type="button" data-input-tag="button.bg-color-tag" data-color-tag="input[name='bg_color']" data-color-style="background-color" <?php if(!empty($data)): ?> style="background-color:<?php echo htmlentities($data['bg_color']); ?>;"<?php endif; ?>>
			...
			<div class="am-form-group">
				<label><?php echo MyLang('form_event_value_title'); ?></label>
				<input type="text" name="event_value" placeholder="<?php echo MyLang('form_event_value_message'); ?>" data-validation-message="<?php echo MyLang('form_event_value_message'); ?>" class="am-radius" <?php if(!empty($data['event_value'])): ?> value="<?php echo htmlentities($data['event_value']); ?>"<?php endif; ?> />
				<?php if(is_array(MyLang('event_value_tips_list'))): ?>
    <div class="am-alert am-alert-warning am-radius am-text-xs" data-am-alert>
        <button type="button" class="am-close">&times;</button>
        <?php foreach(MyLang('event_value_tips_list') as $k=>$v): ?>
			...
			<div class="am-cf">
    			<div class="am-u-sm-4 am-u-md-6 am-padding-horizontal-0">
    				<div class="am-form-group am-form-file">
						<label class="am-block"><?php echo MyLang('common_service.slide.form_item_images_url'); ?><span class="am-form-group-label-tips-must">*</span><?php if(is_array(MyLang('common_service.slide.form_item_images_url_tips'))): ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo implode('<br />', MyLang('common_service.slide.form_item_images_url_tips')); ?>', trigger: 'hover focus', theme: 'sm'}"></a><?php endif; ?></label>
						<ul class="plug-file-upload-view slide-images_url-images-view" data-form-name="images_url" data-max-number="1" data-delete="0" data-dialog-type="images">
							<li>
								<input type="text" name="images_url" value="<?php if(!empty($data['images_url'])): ?><?php echo htmlentities($data['images_url']); ?><?php endif; ?>" data-validation-message="<?php echo MyLang('form_upload_images_message'); ?>" required />
								<img src="<?php if(!empty($data['images_url'])): ?><?php echo htmlentities($data['images_url']); else: ?><?php echo htmlentities($attachment_host); ?>/static/admin/default/images/default-images.jpg<?php endif; ?>" />
							</li>
						</ul>
						<div class="plug-file-upload-submit" data-view-tag="ul.slide-images_url-images-view">+ <?php echo MyLang('form_upload_images_title'); ?></div>
					</div>
    			</div>
    			<div class="am-u-sm-8 am-u-md-6 am-padding-horizontal-0">
    				<div class="am-cf">
		    			<div class="am-u-sm-12 am-padding-horizontal-0">
		    				<div class="am-form-group">
                                <label><?php echo MyLang('form_time_valid_title'); ?></label>
                                <div class="form-multiple-where-input">
                                    <input type="text" name="start_time" autocomplete="off" class="Wdate am-radius" placeholder="<?php echo MyLang('form_time_start_title'); ?>" data-validation-message="<?php echo MyLang('form_time_start_message'); ?>" onclick="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss', maxDate:'#F{$dp.$D(\'end-time\');}'})" <?php if(!empty($data['start_time'])): ?>value="<?php echo htmlentities($data['start_time']); ?>"<?php endif; ?> data-is-clearout="0" id="start-time" />
                                    <span class="am-text-grey">~</span>
                                    <input type="text" name="end_time" autocomplete="off" class="Wdate am-radius" placeholder="<?php echo MyLang('form_time_end_title'); ?>" data-validation-message="<?php echo MyLang('form_time_end_message'); ?>" onclick="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss', minDate:'#F{$dp.$D(\'start-time\');}'})" <?php if(!empty($data['end_time'])): ?>value="<?php echo htmlentities($data['end_time']); ?>"<?php endif; ?> data-is-clearout="0" id="end-time" />
                                </div>
                            </div>
		    			</div>
		    			<div class="am-u-sm-12 am-padding-horizontal-0">
...
<!-- 是否启用 结束 -->
			...
			<div class="am-form-popup-submit">
				...
				<a href="<?php echo MyUrl('admin/slide/index', $params); ?>" class="am-btn am-btn-warning am-radius am-btn-xs am-margin-right-lg">
                    <i class="am-icon-mail-reply"></i>
                    <span><?php echo MyLang('retreat_title'); ?></span>
                </a>
