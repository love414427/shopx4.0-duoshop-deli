<?php /*a:8:{s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/goodscategory/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:64:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/sort.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:63:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/seo.html";i:1699863362;s:70:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				<div class="am-popup-hd">
					<h4 class="am-popup-title" data-add-title="<?php echo MyLang('goodscategory.base_nav_title'); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo MyLang('goodscategory.base_nav_title'); ?><?php echo MyLang('edit_title'); ?>"><?php echo MyLang('goodscategory.base_nav_title'); ?><?php echo MyLang('add_title'); ?></h4>
					<span data-am-modal-close class="am-close">&times;</span>
				</div>
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/goodscategory/save'); ?>" method="POST" request-type="ajax-fun" request-value="TreeFormSaveBack">
						<div class="am-cf">
                			<div class="am-u-sm-6 am-padding-horizontal-0">
                				<div class="am-form-group am-form-file">
									<label class="am-block"><?php echo MyLang('common_service.goodscategory.form_item_icon'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('common_service.goodscategory.form_item_icon_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
									<ul class="plug-file-upload-view goods-category-icon-images-view" data-form-name="icon" data-max-number="1" data-dialog-type="images">
										<li>
											...
											<img src="<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg" />
											<i>×</i>
										</li>
									</ul>
									<div class="plug-file-upload-submit" data-view-tag="ul.goods-category-icon-images-view">+ <?php echo MyLang('form_upload_images_title'); ?></div>
								</div>
                            </div>
                            <div class="am-u-sm-6 am-padding-horizontal-0">
                                <div class="am-form-group am-form-file">
                                    <label class="am-block"><?php echo MyLang('common_service.goodscategory.form_item_icon_active'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('common_service.goodscategory.form_item_icon_active_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
                                    <ul class="plug-file-upload-view goods-category-icon-active-images-view" data-form-name="icon_active" data-max-number="1" data-dialog-type="images">
                                        <li>
                                            <input type="hidden" name="icon_active" value="" />
                                            <img src="<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg" />
                                            <i>×</i>
                                        </li>
                                    </ul>
                                    <div class="plug-file-upload-submit" data-view-tag="ul.goods-category-icon-active-images-view">+ <?php echo MyLang('form_upload_images_title'); ?></div>
                                </div>
                			</div>
                        </div>
                        <div class="am-cf">
                			<div class="am-u-sm-6 am-padding-horizontal-0">
                				<div class="am-form-group am-form-file">
									<label class="am-block"><?php echo MyLang('common_service.goodscategory.form_item_realistic_images'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('common_service.goodscategory.form_item_realistic_images_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
									<ul class="plug-file-upload-view goods-category-realistic_images-images-view" data-form-name="realistic_images" data-max-number="1" data-dialog-type="images">
										<li>
											<input type="hidden" name="realistic_images" value="" />
											<img src="<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg" />
											<i>×</i>
										</li>
									</ul>
									<div class="plug-file-upload-submit" data-view-tag="ul.goods-category-realistic_images-images-view">+ <?php echo MyLang('form_upload_images_title'); ?></div>
								</div>
                			</div>
                            <div class="am-u-sm-6 am-padding-horizontal-0">
                                <div class="am-form-group am-form-file">
                                    <label class="am-block"><?php echo MyLang('common_service.goodscategory.form_item_big_images'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('common_service.goodscategory.form_item_big_images_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
                                    ...
                                    <div class="plug-file-upload-submit" data-view-tag="ul.goods-category-big_images-images-view">+ <?php echo MyLang('form_upload_images_title'); ?></div>
                                </div>
                            </div>
                		</div>
                		...
                		<div class="am-cf">
                			<div class="am-u-sm-6 am-padding-horizontal-0">
                				<div class="am-form-group">
									<label><?php echo MyLang('common_service.goodscategory.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
									<input type="text" placeholder="<?php echo MyLang('common_service.goodscategory.form_item_name_message'); ?>" name="name" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('common_service.goodscategory.form_item_name_message'); ?>" class="am-radius" required />
								</div>
                			</div>
                			<div class="am-u-sm-6 am-padding-horizontal-0">
                				<div class="am-form-group">
									<label><?php echo MyLang('common_service.goodscategory.form_item_vice_name'); ?></label>
									<input type="text" placeholder="<?php echo MyLang('common_service.goodscategory.form_item_vice_name_message'); ?>" name="vice_name" minlength="0" maxlength="60" data-validation-message="<?php echo MyLang('common_service.goodscategory.form_item_vice_name_message'); ?>" class="am-radius" />
								</div>
                			</div>
                		</div>
						...
						<div class="am-cf">
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
									<label><?php echo MyLang('common_service.goodscategory.form_item_describe'); ?></label>
									<textarea rows="1" name="describe" maxlength="200" class="am-radius" placeholder="<?php echo MyLang('common_service.goodscategory.form_item_describe_message'); ?>" data-validation-message="<?php echo MyLang('common_service.goodscategory.form_item_describe_message'); ?>"></textarea>
								</div>
							</div>
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
...
<!-- 排序 结束 -->
                			...
                			<div class="am-u-sm-6 am-u-md-4 am-padding-horizontal-0">
                				<div class="am-form-group">
								    <label class="am-block"><?php echo MyLang('common_service.goodscategory.form_item_is_home_recommended'); ?></label>
								    <input name="is_home_recommended" value="1" type="checkbox" data-off-text="<?php echo MyLang('no_title'); ?>" data-on-text="<?php echo MyLang('yes_title'); ?>" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if((isset($data['is_home_recommended']) and $data['is_home_recommended'] == 1) or !isset($data['is_home_recommended'])): ?>checked="true"<?php endif; ?> />
								</div>
                			</div>
                			<div class="am-u-sm-6 am-u-md-4 am-padding-horizontal-0">
                				<!-- 是否启用 开始 -->
...
<!-- 是否启用 结束 -->
    ...
    <div class="am-u-sm-6 am-u-md-4 am-padding-horizontal-0">
        <div class="am-form-group">
            <label><?php echo MyLang('form_seo_title_title'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('form_seo_title_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
            <input type="text" name="seo_title" placeholder="<?php echo MyLang('form_seo_title_title'); ?>" maxlength="100" data-validation-message="<?php echo MyLang('form_seo_title_message'); ?>" class="am-radius" <?php if(!empty($data['seo_title'])): ?> value="<?php echo htmlentities($data['seo_title']); ?>"<?php endif; ?> />
        </div>
    </div>
    <div class="am-u-sm-6 am-u-md-4 am-padding-horizontal-0">
        <div class="am-form-group">
            <label><?php echo MyLang('form_seo_keywords_title'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('form_seo_keywords_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
            <input type="text" name="seo_keywords" placeholder="<?php echo MyLang('form_seo_keywords_title'); ?>" maxlength="130" data-validation-message="<?php echo MyLang('form_seo_keywords_message'); ?>" class="am-radius" <?php if(!empty($data['seo_keywords'])): ?> value="<?php echo htmlentities($data['seo_keywords']); ?>"<?php endif; ?> />
        </div>
    </div>
    <div class="am-u-sm-12 am-u-md-4 am-padding-horizontal-0">
        <div class="am-form-group">
            <label><?php echo MyLang('form_seo_desc_title'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('form_seo_desc_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
            <textarea rows="1" name="seo_desc" maxlength="230" class="am-radius" placeholder="<?php echo MyLang('form_seo_desc_title'); ?>" data-validation-message="<?php echo MyLang('form_seo_desc_message'); ?>"><?php if(!empty($data['seo_desc'])): ?><?php echo htmlentities($data['seo_desc']); ?><?php endif; ?></textarea>
        </div>
    </div>
</div>
                            </div>
        ...
        <!-- list start -->
		<div id="tree" class="am-margin-top-sm" data-additional='[{"field":"bg_color", "value":"", "type":"input"}, {"field":"bg_color", "value":"", "type":"css", "tag":"button.colorpicker-submit", "style":"background-color"}, {"field":"icon", "value":"", "type":"input"}, {"field":"icon", "value":"<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg", "type":"attr", "tag":"ul.goods-category-icon-images-view li img", "style":"src"}, {"field":"icon_active", "value":"", "type":"input"}, {"field":"icon_active", "value":"<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg", "type":"attr", "tag":"ul.goods-category-icon-active-images-view li img", "style":"src"}, {"field":"realistic_images", "value":"", "type":"input"}, {"field":"realistic_images", "value":"<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg", "type":"attr", "tag":"ul.goods-category-realistic_images-images-view li img", "style":"src"}, {"field":"big_images", "value":"", "type":"input"}, {"field":"big_images", "value":"<?php echo htmlentities($attachment_host); ?>/static/common/images/default-images.jpg", "type":"attr", "tag":"ul.goods-category-big_images-images-view li img", "style":"src"}]' data-node-url="<?php echo MyUrl('admin/goodscategory/getnodeson'); ?>" data-del-url="<?php echo MyUrl('admin/goodscategory/delete'); ?>" data-popup-tag="#data-save-win" data-rank="3">
