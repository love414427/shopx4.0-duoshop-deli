<?php /*a:5:{s:67:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/email/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:65:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/email/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    ...
    <?php if(!empty($nav_data) and is_array($nav_data)): foreach($nav_data as $v): ?>
            <li <?php if($nav_type == $v['type']): ?>class="am-active"<?php endif; ?> data-type="<?php echo htmlentities($v['type']); ?>">
                <a href="<?php echo MyUrl('admin/email/index', ['type'=>$v['type']]); ?>"><?php echo htmlentities($v['name']); ?></a>
            </li>
        <?php endforeach; ?>
    <?php endif; ?>
</ul>
<div class="am-alert am-alert-warning am-radius am-margin-horizontal-sm am-margin-bottom-0" data-am-alert>
    ...
    <p class="am-text-xs"><?php echo MyLang('email.top_tips'); if(!empty($site_store_links) and !empty($site_store_links['email_set_course'])): ?><a href="<?php echo htmlentities($site_store_links['email_set_course']); ?>" class="am-margin-left-sm" target="_blank"><?php echo MyLang('view_config_course_name'); ?> <i class="am-icon-external-link"></i></a><?php endif; ?></p>
</div>
	<!-- table nav end -->

	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/email/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/email/index', ['type'=>'index']); ?>">
			...
			<div class="am-form-group">
				<label><?php echo MyLang('email.form_item_test'); ?><span class="am-form-group-label-tips"><?php echo MyLang('email.form_item_test_tips'); ?></span></label>
				<div class="am-input-group am-input-group-sm">
					<input type="text" placeholder="<?php echo MyLang('email.form_item_test'); ?>" class="am-radius test-email-value" />
					<span class="am-input-group-btn">
						<button class="am-btn am-btn-default am-radius test-email-submit" type="button" data-url="<?php echo MyUrl('admin/email/emailtest'); ?>"><?php echo MyLang('email.form_item_test_button_title'); ?></button>
					</span>
				</div>
			</div>
