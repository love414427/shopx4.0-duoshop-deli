<?php /*a:13:{s:67:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/order/index.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:86:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_top.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_search.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_content.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:89:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_bottom.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_fields_select.html";i:1699863362;s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_page.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_1683078438__=0;$__FOR_END_1683078438__=count($form_table_data_list);for($i=$__FOR_START_1683078438__;$i < $__FOR_END_1683078438__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_454482421__=1;$__FOR_END_454482421__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_454482421__;$star_i <= $__FOR_END_454482421__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
...
<!-- form_table_data_page_end -->
    ...
    <div class="am-modal" tabindex="-1" id="order-take-modal">
        <div class="am-modal-dialog am-radius am-nbfc">
            ...
            <div class="am-modal-bd">
                <form class="am-form form-validation-take" method="post" action="<?php echo MyUrl('admin/order/delivery'); ?>" request-type="ajax-reload">
                    <div class="am-form-group am-form-group-refreshing am-margin-bottom-0">
                        <label><?php echo MyLang('order.form_item_take'); ?></label>
                        <div class="am-form-icon am-nbfc">
                            <i class="am-icon-camera common-scan-submit" data-back-fun="OrderTakeScanBackHandle"></i>
                            <input type="text" autocomplete="off" name="extraction_code" placeholder="<?php echo MyLang('order.form_item_take_message'); ?>" minlength="4" maxlength="4" data-validation-message="<?php echo MyLang('order.form_item_take_message'); ?>" class="am-radius am-form-field" required />
                        </div>
                    </div>
    ...
    <div class="am-popup am-radius" id="order-delivery-popup">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title"><?php echo MyLang('order.form_delivery_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <form class="am-form form-validation-delivery am-form-popup-fixed" method="post" action="<?php echo MyUrl('admin/order/delivery'); ?>" request-type="ajax-reload">
                        ...
                        <?php if(!empty($express_list)): ?>
                            <ul class="am-avg-sm-2 am-avg-md-3 express-list" data-type="express">
                                <?php foreach($express_list as $express): if($express['is_enable'] == 1): ?>
                                        <li class="am-padding-sm" data-value="<?php echo htmlentities($express['id']); ?>">
                                            <div class="business-item am-nbfc am-padding-sm am-radius">
                                                <?php if(!empty($express['icon'])): ?>
                                                    <img src="<?php echo htmlentities($express['icon']); ?>" class="am-radius" />
                                                <?php endif; ?>
    ...
    <p class="am-margin-top-sm"><?php echo MyLang('no_data'); ?></p>
                    ...
                    <div class="am-margin-top-sm">
                        <label><?php echo MyLang('order.form_item_express_number'); ?></label>
                        <input type="text" autocomplete="off" name="express_number" placeholder="<?php echo MyLang('order.form_item_express_number'); ?>" minlength="1" data-validation-message="<?php echo MyLang('order.form_item_express_number_message'); ?>" class="am-radius" required />
                    </div>
    ...
    <div class="am-popup am-radius" id="order-pay-popup">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title"><?php echo MyLang('order.form_payment_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <form class="am-form form-validation-pay am-form-popup-fixed" action="<?php echo MyUrl('admin/order/pay'); ?>" method="POST" request-type="ajax-reload">
                    <div class="business-list business-list-nbfc">
                        <?php if(!empty($buy_payment_list)): ?>
                            <ul class="am-avg-sm-2 am-avg-md-3 payment-list" data-type="payment">
                                <?php foreach($buy_payment_list as $payment): ?>
                                    <li class="am-padding-sm" data-value="<?php echo htmlentities($payment['id']); ?>">
                                        <div class="business-item am-nbfc am-padding-sm am-radius">
                                            <?php if(!empty($payment['logo'])): ?>
                                                <img src="<?php echo htmlentities($payment['logo']); ?>" class="am-radius" />
                                            <?php endif; ?>
