<?php /*a:5:{s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/register/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'register']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['home_user_reg_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_reg_type']['describe']); ?></span></label>
                <?php foreach($common_user_reg_type_list as $v): ?>
                    <label class="am-checkbox-inline">
                        <input type="checkbox" name="<?php echo htmlentities($data['home_user_reg_type']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_reg_type']['value']) and in_array($v['value'], $data['home_user_reg_type']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['home_user_reg_type']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                    </label>
                <?php endforeach; ?>
            </div>

            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['home_user_register_img_verify_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_register_img_verify_state']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_user_register_img_verify_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_user_register_img_verify_state']['error_tips']); ?>" required>
            ...
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['common_register_is_enable_audit']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_register_is_enable_audit']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['common_register_is_enable_audit']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_register_is_enable_audit']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_register_is_enable_audit']['value']) and $data['common_register_is_enable_audit']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['home_is_enable_userregister_agreement']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_is_enable_userregister_agreement']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_is_enable_userregister_agreement']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_is_enable_userregister_agreement']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
            ...
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['home_site_user_register_bg_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_register_bg_images']['describe']); ?></span></label>
                <ul class="plug-file-upload-view home_site_user_register_bg_images-images-view" data-form-name="home_site_user_register_bg_images" data-max-number="1" data-dialog-type="images">
                    <?php if(!empty($data['home_site_user_register_bg_images']['value'])): ?>
                        <li>
                            ...
                            <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_register_bg_images']['value']); ?>" />
                            <i>×</i>
                        </li>
                    <?php endif; ?>
                </ul>
                <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_register_bg_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
            </div>

            <div class="am-form-group">
                    <label class="am-block"><?php echo htmlentities($data['home_site_user_register_bg_color']['name']); ?></label>
                    <input type="hidden" name="<?php echo htmlentities($data['home_site_user_register_bg_color']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_register_bg_color']['value']); ?>" />
                    <button class="am-btn am-btn-default am-btn-xs colorpicker-submit am-btn-block bk-cr-white am-text-right bg-color-tag-<?php echo htmlentities($data['home_site_user_register_bg_color']['only_tag']); ?>" type="button" data-input-tag="button.bg-color-tag-<?php echo htmlentities($data['home_site_user_register_bg_color']['only_tag']); ?>" data-color-tag="input[name='<?php echo htmlentities($data['home_site_user_register_bg_color']['only_tag']); ?>']" data-color-style="background-color" <?php if(!empty($data['home_site_user_register_bg_color']['value'])): ?> style="background-color:<?php echo htmlentities($data['home_site_user_register_bg_color']['value']); ?>;"<?php endif; ?>>
