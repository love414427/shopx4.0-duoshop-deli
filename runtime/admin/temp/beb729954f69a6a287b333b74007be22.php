<?php /*a:5:{s:65:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/sms/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:63:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/sms/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	...
	<?php if(!empty($nav_data) and is_array($nav_data)): foreach($nav_data as $v): ?>
            <li <?php if($nav_type == $v['type']): ?>class="am-active"<?php endif; ?> data-type="<?php echo htmlentities($v['type']); ?>">
                <a href="<?php echo MyUrl('admin/sms/index', ['type'=>$v['type']]); ?>"><?php echo htmlentities($v['name']); ?></a>
            </li>
        <?php endforeach; ?>
    <?php endif; ?>
</ul>
...
<div class="am-alert am-alert-warning am-radius am-margin-bottom-0" data-am-alert>
    ...
    <p class="am-text-xs"><?php echo MyLang('sms.top_tips'); ?> <a href="https://www.aliyun.com/product/sms?userCode=iub0dy6g" class="am-margin-left-sm" target="_blank"><?php echo MyLang('sms.top_to_aliyun_tips'); ?> <i class="am-icon-external-link"></i></a> </p>
</div>
	<!-- table nav end -->

	<div class="content">		
		<!-- form start -->
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/sms/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/sms/index', ['type'=>'index']); ?>">
