<?php /*a:7:{s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/goodsparamstemplate/save_info.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/goodsparamstemplate/tips.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/goodsparamstemplate/table.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/goodsparamstemplate/save'); ?>" method="POST" request-type="ajax-reload" request-value="parent">
			<div class="am-cf">
                <div class="am-u-sm-6 am-padding-horizontal-0">
                	<div class="am-form-group">
						<label><?php echo MyLang('common_service.goodsparamstemplate.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
						<input type="text" name="name" placeholder="<?php echo MyLang('common_service.goodsparamstemplate.form_item_name_message'); ?>" minlength="1" maxlength="80" data-validation-message="<?php echo MyLang('common_service.goodsparamstemplate.form_item_name_message'); ?>" class="am-radius" <?php if(!empty($data['name'])): ?> value="<?php echo htmlentities($data['name']); ?>"<?php endif; ?> required />
					</div>
                </div>
                <div class="am-u-sm-6 am-padding-horizontal-0">
                	<div class="am-form-group">
						<label class="am-block"><?php echo MyLang('common_service.goodsparamstemplate.form_item_category_id'); ?><span class="am-form-group-label-tips-must">*</span><span class="am-form-group-label-tips"><?php echo MyLang('common_service.goodsparamstemplate.form_item_category_id_tips'); ?></span></label>
						<select name="category_id" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('please_select_tips'); ?>" data-validation-message="<?php echo MyLang('common_service.goodsparamstemplate.form_item_category_id_message'); ?>" required>
							<?php if(!empty($goods_category_list)): ?>
								...
								<?php foreach($goods_category_list as $v): ?>
									<option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['category_id']) and $data['category_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
								<?php endforeach; ?>
							<?php endif; ?>
						</select>
					</div>
			...
			<div class="business-form-group">
				<label class="am-block"><?php echo MyLang('common_service.goodsparamstemplate.form_item_config_title'); ?><span class="am-form-group-label-tips-must">*</span></label>
				<?php if(is_array(MyLang('common.form_goods_params_list_tips'))): ?>
    <div class="am-alert am-alert-warning am-radius" data-am-alert>
        <button type="button" class="am-close">&times;</button>
        <p><?php echo implode('</p><p>', MyLang('common.form_goods_params_list_tips')); ?></p>
    </div>
<?php endif; ?>
				<!-- 通过配置生成商品参数 -->
				<div class="am-dropdown" id="parameters-quick-container" data-am-dropdown>
					<span class="business-operations-submit am-dropdown-toggle parameters-quick-add">
						<span><?php echo MyLang('common_service.goodsparamstemplate.form_item_config_template_title'); ?></span>
						<i class="am-icon-caret-down"></i>
					</span>
					<div class="am-dropdown-content parameters-quick-config">
						<textarea rows="5" placeholder="<?php echo MyLang('common_service.goodsparamstemplate.form_item_config_value_placeholder'); ?>"></textarea>
						<button type="button" class="am-btn am-btn-secondary am-btn-xs am-radius am-btn-block am-margin-top-sm"><?php echo MyLang('confirm_title'); ?></button>
					</div>
				</div>
				<!-- 复制操作 -->
				<span class="business-operations-submit am-margin-left-sm parameters-quick-copy">
					<i class="am-icon-copy"></i>
					<span><?php echo MyLang('common_service.goodsparamstemplate.form_item_config_copy_title'); ?></span>
				</span>
			    <!-- 清空操作 -->
			    <span class="business-operations-submit am-margin-left-sm parameters-quick-remove">
					<i class="am-icon-times"></i>
					<span><?php echo MyLang('common_service.goodsparamstemplate.form_item_config_empty_title'); ?></span>
				</span>
				<span class="am-text-warning am-margin-left-sm"><?php echo MyLang('common_service.goodsparamstemplate.form_item_config_list_content_tips'); ?></span>
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <div class="am-padding-sm">
                <textarea rows="5" placeholder="<?php echo MyLang('common.form_goods_params_config_error_tips'); ?>"></textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="parameters-container am-margin-top-sm">
    <table class="am-table am-table-bordered am-table-centered am-table-striped am-table-hover am-margin-bottom-sm parameters-table table-thead-beautify am-margin-bottom-0" 
        data-copy-success-tips="<?php echo MyLang('copy_success'); ?>" 
        data-copy-no-tips="<?php echo MyLang('common.form_goods_params_copy_no_tips'); ?>" 
        data-copy-error-tips="<?php echo MyLang('common.form_goods_params_copy_error_tips'); ?>" 
        data-copy-empty-tips="<?php echo MyLang('config_empty_tips'); ?>" 
        data-created-success-tips="<?php echo MyLang('created_success'); ?>" 
        data-type-all-name="<?php echo MyLang('all_title'); ?>" 
        data-type-base-name="<?php echo MyLang('base_title'); ?>" 
        data-type-detail-name="<?php echo MyLang('detail_title'); ?>" 
        data-type-message="<?php echo MyLang('common.form_goods_params_type_message'); ?>" 
        data-params-name="<?php echo MyLang('common.form_goods_params_params_name'); ?>" 
        data-params-message="<?php echo MyLang('common.form_goods_params_params_message'); ?>" 
        data-value-name="<?php echo MyLang('common.form_goods_params_value_name'); ?>" 
        data-value-message="<?php echo MyLang('common.form_goods_params_value_message'); ?>" 
        data-move-top-name="<?php echo MyLang('moveup_title'); ?>" 
        data-move-bottom-name="<?php echo MyLang('movedown_title'); ?>" 
        data-remove-name="<?php echo MyLang('remove_title'); ?>" 
        data-move-type-tips="<?php echo MyLang('common.form_goods_params_move_type_tips'); ?>" 
        data-move-top-tips="<?php echo MyLang('common.form_goods_params_move_top_tips'); ?>" 
        data-move-bottom-tips="<?php echo MyLang('common.form_goods_params_move_bottom_tips'); ?>" 
    >
        <thead>
            <tr>
                <th class="spec-quick-th-title"><?php echo MyLang('common.form_goods_params_thead_type_title'); ?></th>
                <th class="spec-quick-th-title"><?php echo MyLang('common.form_goods_params_thead_name_title'); ?></th>
                <th class="spec-quick-th-value"><?php echo MyLang('common.form_goods_params_thead_value_title'); ?></th>
                <th class="spec-quick-th-value"><?php echo MyLang('operate_title'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if(!empty($parameters) and is_array($parameters)): foreach($parameters as $pv): ?>
                    <tr>
                        <td class="am-text-middle">
                            <select name="parameters_type[]" class="am-radius chosen-select" data-validation-message="<?php echo MyLang('common.form_goods_params_type_message'); ?>">
                        ...
                        <td class="am-text-middle">
                            <input type="text" name="parameters_name[]" placeholder="<?php echo MyLang('common.form_goods_params_params_name'); ?>" value="<?php echo htmlentities($pv['name']); ?>" data-validation-message="<?php echo MyLang('common.form_goods_params_params_message'); ?>" maxlength="160" class="am-radius" required />
                        </td>
                        <td class="am-text-middle">
                            <input type="text" name="parameters_value[]" placeholder="<?php echo MyLang('common.form_goods_params_value_name'); ?>" value="<?php echo htmlentities($pv['value']); ?>" maxlength="160" data-validation-message="<?php echo MyLang('common.form_goods_params_value_message'); ?>" class="am-radius" />
                        </td>
                        <td class="am-text-middle">
                            <a href="javascript:;" class="am-text-xs am-text-secondary am-margin-right-sm line-move" data-type="top"><?php echo MyLang('moveup_title'); ?></a>
                            <a href="javascript:;" class="am-text-xs am-text-secondary am-margin-right-sm line-move" data-type="bottom"><?php echo MyLang('movedown_title'); ?></a>
                            <a href="javascript:;" class="am-text-xs am-text-danger line-remove"><?php echo MyLang('remove_title'); ?></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
...
<div class="am-margin-top-sm">
    <span class="business-operations-submit parameters-line-add">+ <?php echo MyLang('common.form_goods_params_row_add_title'); ?></span>
</div>
			</div>
			<!-- 是否启用 开始 -->
<div class="am-form-group">
...
<!-- 是否启用 结束 -->
            ...
            <?php endif; if(!empty($plugins_view_admin_goods_params_template_save_data) and is_array($plugins_view_admin_goods_params_template_save_data)): ?>
				<div class="am-alert am-alert-secondary">
					<label class="am-text-sm am-text-warning"><?php echo MyLang('plugins_view_region_config_tips'); ?></label>
					<div>
						<?php foreach($plugins_view_admin_goods_params_template_save_data as $hook): if(is_string($hook) or is_int($hook)): ?>
		                        <?php echo $hook; ?>
		                    <?php endif; ?>
		                <?php endforeach; ?>
					</div>
