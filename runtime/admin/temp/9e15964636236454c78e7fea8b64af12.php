<?php /*a:7:{s:76:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/screeningprice/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:64:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/sort.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:70:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				<div class="am-popup-hd">
					<h4 class="am-popup-title" data-add-title="<?php echo MyLang('screeningprice.base_nav_title'); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo MyLang('screeningprice.base_nav_title'); ?><?php echo MyLang('edit_title'); ?>"><?php echo MyLang('screeningprice.base_nav_title'); ?><?php echo MyLang('add_title'); ?></h4>
					<span data-am-modal-close class="am-close">&times;</span>
				</div>
				<div class="am-popup-bd">
					<?php if(is_array(MyLang('screeningprice.top_tips_list'))): ?>
						<div class="am-alert am-alert-secondary">
							<p><?php echo implode('</p><p>', MyLang('screeningprice.top_tips_list')); ?></p>
						</div>
					<?php endif; ?>
					<!-- form start -->
					<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/screeningprice/save'); ?>" method="POST" request-type="ajax-fun" request-value="TreeFormSaveBack">
						<div class="am-form-group">
							<label><?php echo MyLang('common_service.screeningprice.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
							<input type="text" placeholder="<?php echo MyLang('common_service.screeningprice.form_item_name_message'); ?>" name="name" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('common_service.screeningprice.form_item_name_message'); ?>" class="am-radius" required />
						</div>
						<div class="am-form-group">
							<label><?php echo MyLang('common_service.screeningprice.form_item_min_price'); ?><span class="am-form-group-label-tips-must">*</span></label>
							<input type="number" placeholder="<?php echo MyLang('common_service.screeningprice.form_item_min_price'); ?>" name="min_price" maxlength="10" data-validation-message="<?php echo MyLang('common_service.screeningprice.form_item_min_price_message'); ?>" class="am-radius" value="0" required />
						</div>
						<div class="am-form-group">
							<label><?php echo MyLang('common_service.screeningprice.form_item_max_price'); ?><span class="am-form-group-label-tips-must">*</span></label>
							<input type="number" placeholder="<?php echo MyLang('common_service.screeningprice.form_item_max_price'); ?>" name="max_price" maxlength="10" data-validation-message="<?php echo MyLang('common_service.screeningprice.form_item_max_price_message'); ?>" class="am-radius" value="0" required />
						</div>
						<!-- 排序 开始 -->
<div class="am-form-group">
