<?php /*a:5:{s:72:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/login/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'login']); ?>" enctype="multipart/form-data">
            <!-- 基础配置 -->
            <div class="am-panel am-panel-default am-radius">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_user_login_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_login_type']['describe']); ?></span></label>
                        <?php foreach($common_login_type_list as $v): ?>
                            <label class="am-checkbox-inline">
                                <input type="checkbox" name="<?php echo htmlentities($data['home_user_login_type']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_login_type']['value']) and in_array($v['value'], $data['home_user_login_type']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['home_user_login_type']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                            </label>
                        <?php endforeach; ?>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_user_login_img_verify_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_login_img_verify_state']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_user_login_img_verify_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_user_login_img_verify_state']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_login_img_verify_state']['value']) and $data['home_user_login_img_verify_state']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('images_title'); ?>1</h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_login_ad1_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad1_images']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_user_login_ad1_images-images-view" data-form-name="home_site_user_login_ad1_images" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_user_login_ad1_images']['value'])): ?>
                                <li>
                                    <input type="text" name="home_site_user_login_ad1_images" value="<?php echo htmlentities($data['home_site_user_login_ad1_images']['value']); ?>" />
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_login_ad1_images']['value']); ?>" />
                                    <i>×</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_login_ad1_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_login_ad1_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad1_url']['describe']); ?></span></label>
                        <input type="url" placeholder="<?php echo htmlentities($data['home_site_user_login_ad1_url']['name']); ?>" name="<?php echo htmlentities($data['home_site_user_login_ad1_url']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_login_ad1_url']['value']); ?>" class="am-radius" />
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo MyLang('form_bg_color_title'); ?></label>
                        <input type="hidden" name="<?php echo htmlentities($data['home_site_user_login_ad1_bg_color']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_login_ad1_bg_color']['value']); ?>" />
                        <button class="am-btn am-btn-default am-btn-xs colorpicker-submit am-btn-block bk-cr-white am-text-right bg-color-tag-<?php echo htmlentities($data['home_site_user_login_ad1_bg_color']['only_tag']); ?>" type="button" data-input-tag="button.bg-color-tag-<?php echo htmlentities($data['home_site_user_login_ad1_bg_color']['only_tag']); ?>" data-color-tag="input[name='<?php echo htmlentities($data['home_site_user_login_ad1_bg_color']['only_tag']); ?>']" data-color-style="background-color" <?php if(!empty($data['home_site_user_login_ad1_bg_color']['value'])): ?> style="background-color:<?php echo htmlentities($data['home_site_user_login_ad1_bg_color']['value']); ?>;"<?php endif; ?>>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('images_title'); ?>2</h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_login_ad2_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad2_images']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_user_login_ad2_images-images-view" data-form-name="home_site_user_login_ad2_images" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_user_login_ad2_images']['value'])): ?>
                                <li>
                                    <input type="text" name="home_site_user_login_ad2_images" value="<?php echo htmlentities($data['home_site_user_login_ad2_images']['value']); ?>" />
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_login_ad2_images']['value']); ?>" />
                                    <i>×</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_login_ad2_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_login_ad2_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad2_url']['describe']); ?></span></label>
                        <input type="url" placeholder="<?php echo htmlentities($data['home_site_user_login_ad2_url']['name']); ?>" name="<?php echo htmlentities($data['home_site_user_login_ad2_url']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_login_ad2_url']['value']); ?>" class="am-radius" />
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo MyLang('form_bg_color_title'); ?></label>
                        <input type="hidden" name="<?php echo htmlentities($data['home_site_user_login_ad2_bg_color']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_login_ad2_bg_color']['value']); ?>" />
                        <button class="am-btn am-btn-default am-btn-xs colorpicker-submit am-btn-block bk-cr-white am-text-right bg-color-tag-<?php echo htmlentities($data['home_site_user_login_ad2_bg_color']['only_tag']); ?>" type="button" data-input-tag="button.bg-color-tag-<?php echo htmlentities($data['home_site_user_login_ad2_bg_color']['only_tag']); ?>" data-color-tag="input[name='<?php echo htmlentities($data['home_site_user_login_ad2_bg_color']['only_tag']); ?>']" data-color-style="background-color" <?php if(!empty($data['home_site_user_login_ad2_bg_color']['value'])): ?> style="background-color:<?php echo htmlentities($data['home_site_user_login_ad2_bg_color']['value']); ?>;"<?php endif; ?>>
                            <img src="<?php echo htmlentities($attachment_host); ?>/static/common/images/colorpicker.png" />
                        </button>
                    </div>
                </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('images_title'); ?>3</h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_login_ad3_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad3_images']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_user_login_ad3_images-images-view" data-form-name="home_site_user_login_ad3_images" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_user_login_ad3_images']['value'])): ?>
                                <li>
                                    <input type="text" name="home_site_user_login_ad3_images" value="<?php echo htmlentities($data['home_site_user_login_ad3_images']['value']); ?>" />
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_user_login_ad3_images']['value']); ?>" />
                                    <i>×</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_user_login_ad3_images-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_user_login_ad3_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_login_ad3_url']['describe']); ?></span></label>
                        <input type="url" placeholder="<?php echo htmlentities($data['home_site_user_login_ad3_url']['name']); ?>" name="<?php echo htmlentities($data['home_site_user_login_ad3_url']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_login_ad3_url']['value']); ?>" class="am-radius" />
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo MyLang('form_bg_color_title'); ?></label>
                        <input type="hidden" name="<?php echo htmlentities($data['home_site_user_login_ad3_bg_color']['only_tag']); ?>" value="<?php echo htmlentities($data['home_site_user_login_ad3_bg_color']['value']); ?>" />
                        <button class="am-btn am-btn-default am-btn-xs colorpicker-submit am-btn-block bk-cr-white am-text-right bg-color-tag-<?php echo htmlentities($data['home_site_user_login_ad3_bg_color']['only_tag']); ?>" type="button" data-input-tag="button.bg-color-tag-<?php echo htmlentities($data['home_site_user_login_ad3_bg_color']['only_tag']); ?>" data-color-tag="input[name='<?php echo htmlentities($data['home_site_user_login_ad3_bg_color']['only_tag']); ?>']" data-color-style="background-color" <?php if(!empty($data['home_site_user_login_ad3_bg_color']['value'])): ?> style="background-color:<?php echo htmlentities($data['home_site_user_login_ad3_bg_color']['value']); ?>;"<?php endif; ?>>
                            <img src="<?php echo htmlentities($attachment_host); ?>/static/common/images/colorpicker.png" />
                        </button>
                    </div>
                </div>
