<?php /*a:4:{s:68:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/config/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/config/save', ['view_type'=>$view_type]); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/config/index'); ?>">
            <!-- 基础配置 -->
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['admin_excel_charset']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['admin_excel_charset']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_excel_charset_list') as $v): ?>
                    ...
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['common_excel_export_type']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_excel_export_type']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_excel_export_type_list') as $v): ?>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('config.admin_login_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        ...
                        <?php if(is_array(MyLang('config.admin_login_info_bg_images_list_tips'))): ?>
                            <div class="am-alert am-alert-warning">
                                <p><?php echo implode('</p><p>', MyLang('config.admin_login_info_bg_images_list_tips')); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['admin_login_type']['only_tag']); ?>" multiple="multiple" class="am-radius chosen-select" data-placeholder="<?php echo htmlentities($data['admin_login_type']['name']); ?>" data-validation-message="<?php echo htmlentities($data['admin_login_type']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_login_type_list') as $v): ?>
                    ...
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['admin_login_img_verify_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['admin_login_img_verify_state']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_close_open_list') as $v): ?>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('goods_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('map_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_map_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_map_type']['describe']); ?></span><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('config.map_type_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
                        <select name="<?php echo htmlentities($data['common_map_type']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_map_type']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_map_type_list') as $v): ?>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_baidu_map_ak_server']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_baidu_map_ak_server']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_baidu_map_ak_server']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_baidu_map_ak_server']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_baidu_map_ak_server']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_baidu_map_ak_server']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="business-form-group am-padding-top-0">
                        <div class="am-alert am-alert-warning am-margin-top-0">
                            <?php echo MyLang('config.apply_map_baidu_name'); if(!empty($site_store_links) and !empty($site_store_links['baidu_map_course'])): ?><a href="<?php echo htmlentities($site_store_links['baidu_map_course']); ?>" target="_blank" class="am-margin-left-sm"><?php echo MyLang('view_config_course_name'); ?> <i class="am-icon-external-link"></i></a><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_amap_map_ak_server']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_amap_map_ak_server']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_amap_map_ak_server']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_amap_map_ak_server']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_amap_map_ak_server']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_amap_map_ak_server']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="business-form-group am-padding-top-0">
                        <div class="am-alert am-alert-warning am-margin-top-0">
                            <?php echo MyLang('config.apply_map_amap_name'); if(!empty($site_store_links) and !empty($site_store_links['amap_map_course'])): ?><a href="<?php echo htmlentities($site_store_links['amap_map_course']); ?>" target="_blank" class="am-margin-left-sm"><?php echo MyLang('view_config_course_name'); ?> <i class="am-icon-external-link"></i></a><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_tencent_map_ak_server']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_tencent_map_ak_server']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_tencent_map_ak_server']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_tencent_map_ak_server']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_tencent_map_ak_server']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_tencent_map_ak_server']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="business-form-group am-padding-top-0">
                        <div class="am-alert am-alert-warning am-margin-top-0">
                            <?php echo MyLang('config.apply_map_tencent_name'); if(!empty($site_store_links) and !empty($site_store_links['tencent_map_course'])): ?><a href="<?php echo htmlentities($site_store_links['tencent_map_course']); ?>" target="_blank" class="am-margin-left-sm"><?php echo MyLang('view_config_course_name'); ?> <i class="am-icon-external-link"></i></a><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_tianditu_map_ak_server']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_tianditu_map_ak_server']['describe']); ?></span></label>
                        <input type="text" name="<?php echo htmlentities($data['common_tianditu_map_ak_server']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_tianditu_map_ak_server']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_tianditu_map_ak_server']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_tianditu_map_ak_server']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="business-form-group am-padding-top-0">
                        <div class="am-alert am-alert-warning am-margin-top-0">
                            <?php echo MyLang('config.apply_map_tianditu_name'); if(!empty($site_store_links) and !empty($site_store_links['tianditu_map_course'])): ?><a href="<?php echo htmlentities($site_store_links['tianditu_map_course']); ?>" target="_blank" class="am-margin-left-sm"><?php echo MyLang('view_config_course_name'); ?> <i class="am-icon-external-link"></i></a><?php endif; ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('extend_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('safety_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                    ...
                    <div class="am-form-group">
                        ...
                        <?php if(is_array(MyLang('config.cookie_domain_list_tips'))): ?>
                            <div class="am-alert am-alert-warning">
                                <p><?php echo implode('</p><p>', MyLang('config.cookie_domain_list_tips')); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
