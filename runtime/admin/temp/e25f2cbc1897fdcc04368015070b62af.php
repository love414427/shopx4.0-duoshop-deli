<?php /*a:6:{s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/siteset/search.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:79:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/siteset_nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>$nav_type, 'view_type'=>$view_type]); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_history_record']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_history_record']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_history_record']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_history_record']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['home_search_history_record']['value']) and $data['home_search_history_record']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_keywords_type']['name']); ?></label>
                <select name="<?php echo htmlentities($data['home_search_keywords_type']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_keywords_type']['error_tips']); ?>">
            ...
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_limit_number']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_limit_number']['describe']); ?></span></label>
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" name="<?php echo htmlentities($data['home_search_limit_number']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_search_limit_number']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_search_limit_number']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_search_limit_number']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius"><?php echo MyLang('strip_title'); ?></span>
                </div>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_keywords_where_and']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_keywords_where_and']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_keywords_where_and']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_keywords_where_and']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['home_search_is_keywords_where_and']['value']) and $data['home_search_is_keywords_where_and']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_keywords_seo_fields']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_keywords_seo_fields']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_keywords_seo_fields']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_keywords_seo_fields']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['home_search_is_keywords_seo_fields']['value']) and $data['home_search_is_keywords_seo_fields']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_brand']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_brand']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_brand']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_brand']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_is_brand']['value']) and $data['home_search_is_brand']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_category']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_category']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_category']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_category']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_is_category']['value']) and $data['home_search_is_category']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_price']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_price']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_price']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_price']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_is_price']['value']) and $data['home_search_is_price']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_params']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_params']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_params']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_params']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_is_params']['value']) and $data['home_search_is_params']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_params_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_params_type']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_params_type']['only_tag']); ?>" multiple="multiple" class="am-radius chosen-select" data-placeholder="<?php echo htmlentities($data['home_search_params_type']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_search_params_type']['error_tips']); ?>">
                    <?php foreach($common_goods_parameters_type_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_params_type']['value']) and in_array($v['value'], $data['home_search_params_type']['value'])): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_is_spec']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_is_spec']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_search_is_spec']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_search_is_spec']['error_tips']); ?>" required>
                    <?php foreach($common_close_open_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_is_spec']['value']) and $data['home_search_is_spec']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
