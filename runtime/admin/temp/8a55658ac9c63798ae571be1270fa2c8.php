<?php /*a:4:{s:72:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/sqlconsole/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    <div class="content">
        <div class="am-alert am-alert-warning am-radius" data-am-alert>
            ...
            <p><?php echo MyLang('sqlconsole.top_tips'); ?></p>
        </div>

        <?php if(isset($shopxo_is_develop) and $shopxo_is_develop == true): ?>
            <!-- form start -->
            <form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/sqlconsole/implement'); ?>" method="POST" request-type="ajax-fun" request-value="ViewImplementBack">
                <div class="am-form-group">
                    <textarea name="sql" class="am-radius" placeholder="<?php echo MyLang('common_service.sqlconsole.form_sql_placeholder'); ?>" data-validation-message="<?php echo MyLang('common_service.sqlconsole.form_sql_message'); ?>" required></textarea>
                </div>
                ...
                <div class="am-form-popup-submit">
                    <button type="submit" class="am-btn am-btn-primary am-radius am-btn-xs btn-loading-example" data-am-loading="{spinner: 'circle-o-notch', loadingText:'<?php echo MyLang('execute_title'); ?>'}">
                    <i class="am-icon-send"></i>
                    <span><?php echo MyLang('execute_title'); ?></span>
                </button>
                </div>
            </form>
            <!-- form end -->
        <?php else: ?>
            <div class="am-alert">
                <p><?php echo MyLang('common_service.sqlconsole.form_dev_tips'); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
