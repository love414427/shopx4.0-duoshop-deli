<?php /*a:5:{s:77:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/attachment/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'attachment']); ?>" enctype="multipart/form-data">
            ...
            <div class="am-form-group">
                ...
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" name="<?php echo htmlentities($data['home_max_limit_file']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_max_limit_file']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_max_limit_file']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_max_limit_file']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius">B</span>
                </div>
            </div>
            <div class="am-form-group">
                ...
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" name="<?php echo htmlentities($data['home_max_limit_video']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_max_limit_video']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_max_limit_video']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_max_limit_video']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius">B</span>
                </div>
            </div>
