<?php /*a:7:{s:68:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/region/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:64:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/sort.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:70:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				<div class="am-popup-hd">
					<h4 class="am-popup-title" data-add-title="<?php echo MyLang('region.base_nav_title'); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo MyLang('region.base_nav_title'); ?><?php echo MyLang('edit_title'); ?>"><?php echo MyLang('region.base_nav_title'); ?><?php echo MyLang('add_title'); ?></h4>
					<span data-am-modal-close class="am-close">&times;</span>
				</div>
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/region/save'); ?>" method="POST" request-type="ajax-fun" request-value="TreeFormSaveBack">
						<div class="am-cf">
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
									<label><?php echo MyLang('common_service.region.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
									<input type="text" placeholder="<?php echo MyLang('common_service.region.form_item_name_message'); ?>" name="name" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('common_service.region.form_item_name_message'); ?>" class="am-radius" required />
								</div>
							</div>
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
									<label><?php echo MyLang('common_service.region.form_item_code'); ?></label>
									<input type="text" placeholder="<?php echo MyLang('common_service.region.form_item_code'); ?>" name="code" maxlength="30" data-validation-message="<?php echo MyLang('common_service.region.form_item_code_message'); ?>" class="am-radius" />
								</div>
							</div>
						</div>
						<div class="am-cf">
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
									<label><?php echo MyLang('common_service.region.form_item_lng'); ?></label>
									<input type="number" placeholder="<?php echo MyLang('common_service.region.form_item_lng'); ?>" name="lng" step="0.01" data-validation-message="<?php echo MyLang('common_service.region.form_item_lng_message'); ?>" class="am-radius" />
								</div>
							</div>
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
									<label><?php echo MyLang('common_service.region.form_item_lat'); ?></label>
									<input type="number" placeholder="<?php echo MyLang('common_service.region.form_item_lat'); ?>" name="lat" step="0.01" data-validation-message="<?php echo MyLang('common_service.region.form_item_lat_message'); ?>" class="am-radius" />
								</div>
							</div>
						</div>
						<div class="am-cf">
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<div class="am-form-group">
									<label><?php echo MyLang('common_service.region.form_item_letters'); ?></label>
									<input type="text" placeholder="<?php echo MyLang('common_service.region.form_item_letters'); ?>" name="letters" data-validation-message="<?php echo MyLang('common_service.region.form_item_letters_message'); ?>" class="am-radius" value="" />
								</div>
							</div>
							<div class="am-u-sm-6 am-padding-horizontal-0">
								<!-- 排序 开始 -->
...
<!-- 是否启用 结束 -->
        ...
        <!-- list start -->
		<div id="tree" class="am-margin-top-sm" data-node-url="<?php echo MyUrl('admin/region/getnodeson'); ?>" data-del-url="<?php echo MyUrl('admin/region/delete'); ?>" data-popup-tag="#data-save-win" data-rank="3">
