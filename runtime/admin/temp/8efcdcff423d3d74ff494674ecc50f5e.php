<?php /*a:6:{s:67:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/theme/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:65:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/theme/nav.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    ...
    <?php if(!empty($base_nav)): foreach($base_nav as $v): ?>
            <li <?php if($view_type == $v['type']): ?>class="am-active"<?php endif; ?>>
                <a href="<?php echo MyUrl('admin/theme/index', ['view_type'=>$v['type']]); ?>"><?php echo htmlentities($v['name']); ?></a>
            </li>
        <?php endforeach; ?>
    <?php endif; if($is_system_show_base == 1 and !empty($store_theme_url)): ?>
        <li class="am-fr">
            <a class="am-margin-left-sm" href="<?php echo htmlentities($store_theme_url); ?>" target="_blank"><?php echo MyLang('theme.nav_store_theme_name'); ?> <i class="am-icon-external-link"></i></a>
        </li>
    <?php endif; ?>
</ul>
        <!-- nav end -->
            ...
            <ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery-bordered data-list" data-am-gallery="{}" data-select-url="<?php echo MyUrl('admin/theme/save'); ?>">
                <?php foreach($data_list as $v): ?>
                    <li id="data-list-<?php echo htmlentities($v['theme']); ?>">
                        <div class="am-gallery-item am-radius am-padding-0 <?php if($v['theme'] == $theme): ?>theme-active<?php endif; ?>">
                            <a href="javascript:;" class="select-theme am-block" data-theme="<?php echo htmlentities($v['theme']); ?>">
                                <img src="<?php echo htmlentities($v['preview']); ?>" alt="<?php echo htmlentities($v['name']); ?>" class="am-block" />
                            </a>
                            <div class="am-gallery-item-bottom am-padding-sm">
                                <h3 class="am-gallery-title am-margin-top-0">
                                    ...
                                    <div class="am-fr am-text-right">
                                        <?php if(!empty($upgrade_info) and isset($upgrade_info[$v['theme']]) and version_compare($upgrade_info[$v['theme']]['version_new'], $v['ver'], '>')): ?>
                                            <a href="javascript:;" class="am-icon-refresh am-text-danger package-upgrade-event" title="<?php echo MyLang('update_title'); ?>" data-type="webtheme" data-name="<?php echo htmlentities($v['name']); ?>" data-value="<?php echo htmlentities($v['theme']); ?>" data-json="<?php echo urlencode(json_encode($upgrade_info[$v['theme']])); ?>"></a>
                                        <?php endif; if(isset($shopxo_is_develop) and $shopxo_is_develop == true): ?>
                                            <a href="<?php echo MyUrl('admin/theme/download', ['id'=>$v['theme']]); ?>" class="am-icon-trash-o am-icon-download am-margin-left-sm" title="<?php echo MyLang('download_title'); ?>"></a>
                                        <?php endif; if($v['is_delete'] == 1): ?>
                                            <a href="javascript:;" class="am-icon-trash-o submit-delete am-margin-left-sm am-text-warning" title="<?php echo MyLang('delete_title'); ?>" data-url="<?php echo MyUrl('admin/theme/delete'); ?>" data-id="<?php echo htmlentities($v['theme']); ?>"></a>
                                        <?php endif; if(!empty($upgrade_info) and isset($upgrade_info[$v['theme']]) and !empty($upgrade_info[$v['theme']]['version_main']) and $upgrade_info[$v['theme']]['version_main'] != $v['ver']): ?>
                                            <span class="am-fr am-text-danger am-margin-left-sm">v<?php echo htmlentities($upgrade_info[$v['theme']]['version_main']); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </h3>
                                <div class="am-gallery-desc"><?php echo MyLang('theme.list_author_title'); ?>：
                                    <?php if(empty($v['home'])): ?>
                                        <?php echo htmlentities($v['author']); else: ?>
                                        <a href="<?php echo htmlentities($v['home']); ?>" target="_blank"><?php echo htmlentities($v['author']); ?></a>
                                    <?php endif; ?>
                                </div>
                                <div class="am-gallery-desc"><?php echo MyLang('theme.list_version_title'); ?>：<?php echo htmlentities($v['ver']); ?></div>
                            </div>
                        </div>
                    </li>
                <?php endforeach; ?>
