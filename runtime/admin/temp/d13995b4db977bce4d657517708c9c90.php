<?php /*a:5:{s:70:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/appmini/config.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:67:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/appmini/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
	...
	<div class="content">
	    ...
	    <div class="am-alert am-alert-warning am-radius">
	    	<a class="am-fr" href="<?php echo htmlentities($store_theme_url); ?>" target="_blank"><?php echo MyLang('appmini.nav_store_theme_name'); ?> <i class="am-icon-external-link"></i></a>
	        <p class="am-text-sm"><?php echo MyLang('appmini.nav_theme_download_tips'); ?></p>
	        <p class="am-margin-top-xs">
	            <a href="https://uniapp.shopxo.net/" target="_blank"><?php echo MyLang('appmini.nav_theme_download_name'); ?> <i class="am-icon-external-link"></i></a>
	        </p>
	    </div>

		<!-- form start -->
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/appmini/save', ['nav_type'=>$nav_type]); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/appmini/config', ['nav_type'=>$nav_type]); ?>">
			<?php switch($nav_type): case "weixin": ?>
					...
					<div class="am-panel am-panel-default am-radius">
						<div class="am-panel-hd">
							<h3 class="am-panel-title"><?php echo MyLang('extend_config_title'); ?></h3>
						</div>
						<div class="am-panel-bd">
							<div class="am-form-group">
								<label><?php echo htmlentities($data['common_app_mini_weixin_privacy_content']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_mini_weixin_privacy_content']['describe']); ?></span></label>
				...
				<?php break; case "alipay": ?>
					...
					<div class="am-panel am-panel-default am-radius">
						<div class="am-panel-hd">
							<h3 class="am-panel-title"><?php echo MyLang('appmini.form_alipay_extend_title'); ?></h3>
						</div>
						<div class="am-panel-bd">
							<!-- tips -->
					        <div class="am-alert am-alert-warning" data-am-alert>
					            ...
					            <p>
					                <span><?php echo MyLang('appmini.form_alipay_extend_tips'); ?></span>
					                <a href="https://opendocs.alipay.com/mini/component/contact-button" target="_blank" class="am-margin-left-sm"><?php echo MyLang('view_title'); ?> <i class="am-icon-external-link"></i></a>
					            </p>
					        </div>
							<div class="am-form-group">
				...
				<?php break; default: ?>
					<div class="table-no"><i class="am-icon-warning"></i> <?php echo htmlentities($nav_type); ?><?php echo MyLang('no_config_data_tips'); ?></div>
			<?php endswitch; ?>
