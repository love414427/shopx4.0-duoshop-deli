<?php /*a:13:{s:76:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/orderaftersale/index.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:86:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_top.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_search.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_content.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:89:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_bottom.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_fields_select.html";i:1699863362;s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_page.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_2092263375__=0;$__FOR_END_2092263375__=count($form_table_data_list);for($i=$__FOR_START_2092263375__;$i < $__FOR_END_2092263375__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_1651359231__=1;$__FOR_END_1651359231__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_1651359231__;$star_i <= $__FOR_END_1651359231__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
...
<!-- form_table_data_page_end -->
    ...
    <!-- 审核弹窗 -->
    <div class="am-popup am-radius" id="order-audit-popup">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title"><?php echo MyLang('orderaftersale.form_audit_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <dl class="dl-content">
                    <dt><?php echo MyLang('orderaftersale.form_user_info_title'); ?></dt>
                    <dd class="user-info">
                       <img src="<?php echo htmlentities($attachment_host); ?>/static/common/images/user-img-sm.gif" class="am-img-thumbnail am-radius am-align-left am-margin-right-xs am-margin-bottom-0 am-fl" width="35" height="35" />
                        <div class="user-base">
                            <p class="username"><?php echo MyLang('user_username_title'); ?>：<span>...</span></p>
                            <p class="nickname"><?php echo MyLang('user_nickname_title'); ?>：<span>...</span></p>
                            <p class="mobile"><?php echo MyLang('user_mobile_title'); ?>：<span>...</span></p>
                            <p class="email"><?php echo MyLang('user_email_title'); ?>：<span>...</span></p>
                        </div>
                    </dd>
                    <dt><?php echo MyLang('orderaftersale.form_apply_info_title'); ?></dt>
                    <dd class="apply-info">
                        <div>
                            <p class="type"><?php echo MyLang('orderaftersale.forn_apply_info_type'); ?>：<span>...</span></p>
                            <p class="reason"><?php echo MyLang('orderaftersale.forn_apply_info_reason'); ?>：<span>...</span></p>
                            <p class="number"><?php echo MyLang('orderaftersale.forn_apply_info_number'); ?>：<span>...</span></p>
                            <p class="price"><?php echo MyLang('orderaftersale.forn_apply_info_price'); ?>：<span class="am-text-warning">...</span></p>
                            <p class="msg"><?php echo MyLang('orderaftersale.forn_apply_info_msg'); ?>：<span>...</span></p>
                        </div>
                    </dd>
                </dl>

                <form class="am-form form-validation-audit am-form-popup-fixed" action="<?php echo MyUrl('admin/orderaftersale/audit'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group reply-submit am-form-group-refreshing">
                        <label class="am-block"><?php echo MyLang('common_service.orderaftersale.form_item_refundment'); ?></label>
                        <?php if(!empty($common_order_aftersale_refundment_list)): foreach($common_order_aftersale_refundment_list as $v): ?>
                                <label class="am-radio-inline am-success">
                                    <input type="radio" name="refundment" value="<?php echo htmlentities($v['value']); ?>" data-am-ucheck data-validation-message="<?php echo MyLang('common_service.orderaftersale.form_item_refundment_message'); ?>" required /> <?php echo htmlentities($v['name']); ?>
                                </label>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </div>
    ...
    <!-- 拒绝弹窗 -->
    <div class="am-popup am-radius" id="order-refuse-popup">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title"><?php echo MyLang('orderaftersale.form_refuse_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <dl class="dl-content">
                ...
                <form class="am-form form-validation-refuse am-form-popup-fixed" action="<?php echo MyUrl('admin/orderaftersale/refuse'); ?>" method="POST" request-type="ajax-reload">
                    <div class="am-form-group reply-submit am-form-group-refreshing">
                        <label><?php echo MyLang('common_service.orderaftersale.form_item_refuse_reason'); ?></label>
                        <textarea name="refuse_reason" rows="5" class="am-radius" placeholder="<?php echo MyLang('common_service.orderaftersale.form_item_refuse_reason_message'); ?>" data-validation-message="<?php echo MyLang('common_service.orderaftersale.form_item_refuse_reason_message'); ?>" minlength="2" maxlength="230" required></textarea>
                    </div>
