<?php /*a:13:{s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/payment/index.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:86:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_top.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_search.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_content.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:89:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_bottom.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_fields_select.html";i:1699863362;s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_page.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-form-table-data-container content-right">
    ...
    <button type="button" class="am-btn am-btn-success am-btn-xs am-icon-cloud-upload am-radius" data-am-modal="{target: '#payment-upload-win'}"> <?php echo MyLang('upload_title'); ?></button>
    <?php if($is_system_show_base == 1 and !empty($store_payment_url)): ?>
        <a class="am-margin-left-sm" href="<?php echo htmlentities($store_payment_url); ?>" target="_blank"><?php echo MyLang('payment.nav_store_payment_name'); ?> <i class="am-icon-external-link"></i></a>
    <?php endif; ?>
    <!-- 父级内容 -->
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_2045535191__=0;$__FOR_END_2045535191__=count($form_table_data_list);for($i=$__FOR_START_2045535191__;$i < $__FOR_END_2045535191__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_95574239__=1;$__FOR_END_95574239__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_95574239__;$star_i <= $__FOR_END_95574239__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
    ...
    <div class="am-popup am-radius" id="payment-upload-win">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title"><?php echo MyLang('upload_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <!-- win form start -->
                <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/payment/upload'); ?>" method="POST" request-type="ajax-reload" enctype="multipart/form-data">
                    <?php if(is_array(MyLang('payment.upload_top_list_tips'))): ?>
                        <div class="am-alert am-radius am-alert-tips">
                            <?php foreach(MyLang('payment.upload_top_list_tips') as $v): ?>
                                <p><?php echo htmlentities($v['name']); ?></p>
                                <?php if(!empty($v['item']) and is_array($v['item'])): ?>
                                ...
                                <?php endif; ?>
                            <?php endforeach; ?>
                            <p class="am-margin-top-xs am-text-danger"><?php echo MyLang('payment.upload_top_tips_ps'); ?></p>
                        </div>
                    <?php endif; ?>
