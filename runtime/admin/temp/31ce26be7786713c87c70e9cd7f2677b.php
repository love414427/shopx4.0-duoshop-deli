<?php /*a:13:{s:68:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/design/index.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:86:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_top.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_search.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_content.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:89:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_bottom.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_fields_select.html";i:1699863362;s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_page.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-form-table-data-container content-right">
    ...
    <button type="button" class="am-btn am-btn-success am-btn-xs am-icon-cloud-upload am-radius" data-am-modal="{target: '#popup-design-upload'}"> <?php echo MyLang('import_title'); ?></button>
    <a href="<?php echo MyUrl('admin/design/saveinfo'); ?>" class="am-btn am-btn-secondary am-radius am-btn-xs am-icon-plus" target="_blank"> <?php echo MyLang('add_title'); ?></a>
    <!-- 父级内容 -->
...
<?php endif; if($is_system_show_base == 1 and !empty($store_design_url)): ?>
        <a class="am-margin-left-sm" href="<?php echo htmlentities($store_design_url); ?>" target="_blank"><?php echo MyLang('design.nav_store_design_name'); ?> <i class="am-icon-external-link"></i></a>
    <?php endif; ?>
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_1397020319__=0;$__FOR_END_1397020319__=count($form_table_data_list);for($i=$__FOR_START_1397020319__;$i < $__FOR_END_1397020319__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_331710922__=1;$__FOR_END_331710922__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_331710922__;$star_i <= $__FOR_END_331710922__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
    ...
    <div class="am-popup am-radius" id="popup-design-upload">
        <div class="am-popup-inner">
            <div class="am-popup-hd">
                <h4 class="am-popup-title"><?php echo MyLang('import_title'); ?></h4>
                <span data-am-modal-close class="am-close">&times;</span>
            </div>
            <div class="am-popup-bd">
                <!-- win form start -->
                <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/design/upload'); ?>" method="POST" request-type="ajax-reload" enctype="multipart/form-data">
                    <?php if(is_array(MyLang('design.upload_list_tips'))): ?>
                        <div class="am-alert am-radius am-alert-tips">
                            <p class="am-margin-top-xs"><?php echo implode('</p><p class="am-margin-top-xs">', MyLang('design.upload_list_tips')); ?></p>
                        </div>
                    <?php endif; ?>
                    <div class="am-form-group am-form-group-refreshing">
                        <div class="am-form-file">
                            <button type="button" class="am-btn am-btn-default am-btn-sm am-radius"><i class="am-icon-cloud-upload"></i> <?php echo MyLang('form_choice_file_title'); ?></button>
                            <input type="file" name="file" class="file-event" data-tips-tag="#form-payment-tips" data-validation-message="<?php echo MyLang('form_upload_file_message'); ?>" accept=".zip" multiple required />
