<?php /*a:5:{s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/base/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
	...
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index'); ?>" enctype="multipart/form-data">
			<!-- 基础配置 -->
            <div class="am-panel am-panel-default am-radius">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
					...
					<div class="am-form-group">
						<label class="am-block"><?php echo htmlentities($data['home_site_logo']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_logo']['describe']); ?></span></label>
						<ul class="plug-file-upload-view home_site_logo-images-view" data-form-name="home_site_logo" data-max-number="1" data-dialog-type="images">
							<?php if(!empty($data['home_site_logo']['value'])): ?>
								<li>
									...
									<img src="<?php echo AttachmentPathViewHandle($data['home_site_logo']['value']); ?>" />
                                    <i>x</i>
								</li>
							<?php endif; ?>
						</ul>
						<div class="plug-file-upload-submit" data-view-tag="ul.home_site_logo-images-view">+ <?php echo MyLang('site.choice_upload_logo_title'); ?></div>
					</div>

					<div class="am-form-group">
						<label class="am-block"><?php echo htmlentities($data['home_site_logo_wap']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_logo_wap']['describe']); ?></span></label>
						<ul class="plug-file-upload-view home_site_logo_wap-images-view" data-form-name="home_site_logo_wap" data-max-number="1" data-dialog-type="images">
							<?php if(!empty($data['home_site_logo_wap']['value'])): ?>
								<li>
									...
									<img src="<?php echo AttachmentPathViewHandle($data['home_site_logo_wap']['value']); ?>" />
                                    <i>x</i>
								</li>
							<?php endif; ?>
						</ul>
						<div class="plug-file-upload-submit" data-view-tag="ul.home_site_logo_wap-images-view">+ <?php echo MyLang('site.choice_upload_logo_title'); ?></div>
					</div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['home_site_logo_app']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_logo_app']['describe']); ?></span></label>
                        <ul class="plug-file-upload-view home_site_logo_app-images-view" data-form-name="home_site_logo_app" data-max-number="1" data-dialog-type="images">
                            <?php if(!empty($data['home_site_logo_app']['value'])): ?>
                                <li>
                                    <input type="text" name="home_site_logo_app" value="<?php echo htmlentities($data['home_site_logo_app']['value']); ?>" />
                                    <img src="<?php echo AttachmentPathViewHandle($data['home_site_logo_app']['value']); ?>" />
                                    <i>x</i>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <div class="plug-file-upload-submit" data-view-tag="ul.home_site_logo_app-images-view">+ <?php echo MyLang('site.choice_upload_logo_title'); ?></div>
                    </div>

					<div class="am-form-group">
						<label class="am-block"><?php echo htmlentities($data['home_site_logo_square']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_logo_square']['describe']); ?></span></label>
						<ul class="plug-file-upload-view home_site_logo_square-images-view" data-form-name="home_site_logo_square" data-max-number="1" data-dialog-type="images">
							<?php if(!empty($data['home_site_logo_square']['value'])): ?>
								<li>
									<input type="text" name="home_site_logo_square" value="<?php echo htmlentities($data['home_site_logo_square']['value']); ?>" />
									<img src="<?php echo AttachmentPathViewHandle($data['home_site_logo_square']['value']); ?>" />
                                    <i>x</i>
								</li>
							<?php endif; ?>
						</ul>
						<div class="plug-file-upload-submit" data-view-tag="ul.home_site_logo_square-images-view">+ <?php echo MyLang('site.choice_upload_logo_title'); ?></div>
					</div>
					...
					<div class="am-form-group">
						...
						<select name="<?php echo htmlentities($data['common_timezone']['only_tag']); ?>" class="am-radius chosen-select" data-placeholder="<?php echo htmlentities($data['common_timezone']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_timezone']['error_tips']); ?>" required>
							<?php foreach($common_site_timezone_list as $k=>$v): ?>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_site_status_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
					<div class="am-form-group">
						...
						<select name="<?php echo htmlentities($data['home_site_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_site_state']['error_tips']); ?>" required>
					...
					<div class="am-form-group">
						<label><?php echo htmlentities($data['home_site_web_home_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_web_home_state']['describe']); ?></span></label>
						<select name="<?php echo htmlentities($data['home_site_web_home_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_site_web_home_state']['error_tips']); ?>" required>
							<?php foreach($common_close_open_list as $v): ?>
								<option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_site_web_home_state']['value']) and $data['home_site_web_home_state']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
					<div class="am-form-group">
						<label><?php echo htmlentities($data['home_site_web_pc_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_web_pc_state']['describe']); ?></span></label>
						<select name="<?php echo htmlentities($data['home_site_web_pc_state']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_site_web_pc_state']['error_tips']); ?>" required>
							<?php foreach($common_close_open_list as $v): ?>
								<option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_site_web_pc_state']['value']) and $data['home_site_web_pc_state']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
					<div class="am-form-group">
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_site_domain_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                	<?php if(is_array(MyLang('site.site_domain_tips_list'))): ?>
	                    <div class="am-alert am-alert-warning am-margin-top-xs" data-am-alert>
	                        <button type="button" class="am-close">&times;</button>
	                        <p><?php echo implode('</p><p>', MyLang('site.site_domain_tips_list')); ?></p>
	                    </div>
                    <?php endif; ?>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_domain_host']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_domain_host']['describe']); ?></span></label>
                        <input type="url" name="<?php echo htmlentities($data['common_domain_host']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_domain_host']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_domain_host']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_domain_host']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cdn_attachment_host']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cdn_attachment_host']['describe']); ?></span></label>
                        <input type="url" name="<?php echo htmlentities($data['common_cdn_attachment_host']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cdn_attachment_host']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cdn_attachment_host']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cdn_attachment_host']['value']); ?>"<?php endif; ?> />
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_cdn_public_host']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_cdn_public_host']['describe']); ?></span></label>
                        <input type="url" name="<?php echo htmlentities($data['common_cdn_public_host']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_cdn_public_host']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['common_cdn_public_host']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_cdn_public_host']['value']); ?>"<?php endif; ?> />
                    </div>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_site_filing_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                	<div class="am-form-group">
		            ...
		            <div class="am-form-group">
		                <label><?php echo htmlentities($data['home_site_security_record_name']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_security_record_name']['describe']); ?></span></label>
		                <input type="text" name="<?php echo htmlentities($data['home_site_security_record_name']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_site_security_record_name']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['home_site_security_record_name']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_site_security_record_name']['value']); ?>"<?php endif; ?> />
		            </div>
		            <div class="am-form-group">
		                <label><?php echo htmlentities($data['home_site_security_record_url']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_security_record_url']['describe']); ?></span></label>
		                <input type="text" name="<?php echo htmlentities($data['home_site_security_record_url']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_site_security_record_url']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['home_site_security_record_url']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_site_security_record_url']['value']); ?>"<?php endif; ?> />
		            </div>

		            <div class="am-form-group">
		                <label><?php echo htmlentities($data['home_site_telecom_license']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_telecom_license']['describe']); ?></span></label>
		                <input type="text" name="<?php echo htmlentities($data['home_site_telecom_license']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_site_telecom_license']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['home_site_telecom_license']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_site_telecom_license']['value']); ?>"<?php endif; ?> />
		            </div>

		            <div class="am-form-group">
		                <label><?php echo htmlentities($data['home_site_company_license']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_company_license']['describe']); ?></span></label>
		                <input type="text" name="<?php echo htmlentities($data['home_site_company_license']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_site_company_license']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['home_site_company_license']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_site_company_license']['value']); ?>"<?php endif; ?> />
		            </div>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_site_other_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
					<div class="am-form-group">
