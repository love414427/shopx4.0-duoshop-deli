...
<div class="am-form-table-data-container content-right">
    ...
    <a href="<?php echo MyUrl('admin/slide/saveinfo'); ?>" class="am-btn am-btn-secondary am-radius am-btn-xs am-icon-plus"> <?php echo MyLang('add_title'); ?></a>
    <!-- 父级内容 -->
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_309134808__=0;$__FOR_END_309134808__=count($form_table_data_list);for($i=$__FOR_START_309134808__;$i < $__FOR_END_309134808__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_725629980__=1;$__FOR_END_725629980__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_725629980__;$star_i <= $__FOR_END_725629980__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
