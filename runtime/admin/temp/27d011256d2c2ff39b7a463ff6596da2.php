<?php /*a:6:{s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/sitetype/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/region_linkage.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'sitetype']); ?>" enctype="multipart/form-data">
            <!-- 基础配置 -->
            <div class="am-panel am-panel-default am-radius">
                ...
                <div class="am-panel-bd am-padding-vertical-0">
                    <!-- 提示 -->
                    <?php if(is_array(MyLang('site.sitetype_top_tips_list'))): ?>
                        <div class="am-alert am-alert-warning am-radius am-margin-top am-margin-bottom-0" data-am-alert>
                            <button type="button" class="am-close">&times;</button>
                            <p><?php echo implode('</p><p>', MyLang('site.sitetype_top_tips_list')); ?></p>
                        </div>
                    <?php endif; ?>

                    <!-- 站点类型 -->
                    <div class="am-form-group platform-list-value-container">
                        <label class="am-block"><?php echo htmlentities($data['common_site_type']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_site_type']['describe']); ?></span></label>
                        <?php foreach($common_platform_type as $v): ?>
                            <div class="am-input-group am-input-group-sm">
                                ...
                                <select name="<?php echo htmlentities($data['common_site_type']['only_tag']); ?>[<?php echo htmlentities($v['value']); ?>]" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('optional_tips'); ?>" data-validation-message="<?php echo MyLang('site.site_setup_choice_payment_message', ['name'=>$v['name']]); ?>">
                                    <?php if(!empty($common_site_type_list)): foreach($common_site_type_list as $site): ?>
                                            <option value="<?php echo htmlentities($site['value']); ?>" <?php if(!empty($data['common_site_type']) and !empty($data['common_site_type']['value']) and isset($data['common_site_type']['value'][$v['value']]) and $data['common_site_type']['value'][$v['value']] == $site['value']): ?>selected<?php endif; ?>><?php echo htmlentities($site['name']); ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_display_type_title'); ?></span>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_is_exhibition_mode_btn_text']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_is_exhibition_mode_btn_text']['describe']); ?></span></label>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_self_extraction_title'); ?></h3>
                </div>
                <div class="am-panel-bd">
                    <ul class="am-list am-list-static am-list-border am-list-striped am-form-group am-btn-sm am-form-group-refreshing am-margin-bottom-0 am-padding-bottom-0 address-list">
                        <?php if(!empty($sitetype_address_list) and is_array($sitetype_address_list)): foreach($sitetype_address_list as $address): ?>
                                <li>
                                    ...
                                    <span class="am-badge am-radius am-icon-remove delete-submit"> <?php echo MyLang('remove_title'); ?></span>
                                    <span class="am-badge am-radius am-icon-edit edit-submit"> <?php echo MyLang('edit_title'); ?></span>
                                </li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
                    ...
                    <button type="button" class="am-btn am-btn-secondary am-radius am-icon-plus am-btn-sm am-margin-top-sm address-submit-add"> <?php echo MyLang('site.add_self_extractio_address_title'); ?></button>
                </div>
            </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_fictitious_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_site_fictitious_return_title']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_site_fictitious_return_title']['describe']); ?></span></label>
                    ...
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_site_fictitious_return_tips']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_site_fictitious_return_tips']['describe']); ?></span></label>
...
<div class="am-popup am-radius" id="popup-address-win">
    <div class="am-popup-inner">
        <div class="am-popup-hd">
            <h4 class="am-popup-title"><?php echo MyLang('site.form_take_address_title'); ?></h4>
        ...
        <div class="am-popup-bd">
            <form class="am-form form-validation-address am-form-full-screen am-form-popup-fixed" method="post" request-type="sync" request-value="ViewAddressModalBack">
                <div class="am-cf">
                    <div class="am-u-sm-6 am-padding-horizontal-0">
                        <div class="am-form-group am-form-file">
                            <label class="am-block"><?php echo MyLang('site.form_take_address_logo'); ?><span class="am-form-group-label-tips"><?php echo MyLang('site.form_take_address_logo_tips'); ?></span></label>
                            <ul class="plug-file-upload-view sitetype-logo" data-form-name="logo" data-max-number="1" data-dialog-type="images"></ul>
                            <div class="plug-file-upload-submit" data-view-tag="ul.sitetype-logo">+ <?php echo MyLang('form_upload_images_title'); ?></div>
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-padding-horizontal-0">
                        <div class="am-form-group">
                            <label class="am-block"><?php echo MyLang('site.form_take_address_alias'); ?></label>
                            <input type="text" name="alias" placeholder="<?php echo MyLang('site.form_take_address_alias_message'); ?>" minlength="0" maxlength="16" data-validation-message="<?php echo MyLang('site.form_take_address_alias_message'); ?>" class="am-radius" />
                        </div>
                    </div>
                </div>
                ...
                <div class="am-cf">
                    <div class="am-u-sm-6 am-padding-horizontal-0">
                        <div class="am-form-group">
                            <label class="am-block"><?php echo MyLang('site.form_take_address_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
                            <input type="text" name="name" placeholder="<?php echo MyLang('site.form_take_address_name_message'); ?>" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('site.form_take_address_name_message'); ?>" class="am-radius" required />
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-padding-horizontal-0">
                        <div class="am-form-group">
                            <label class="am-block"><?php echo MyLang('site.form_take_address_tel'); ?><span class="am-form-group-label-tips-must">*</span></label>
                            <input type="text" name="tel" placeholder="<?php echo MyLang('site.form_take_address_tel'); ?>" minlength="6" maxlength="30" data-validation-message="<?php echo MyLang('site.form_take_address_tel_message'); ?>" class="am-radius" required />
                        </div>
                    </div>
                </div>

                <div class="am-form-group region-linkage" data-url="<?php echo MyUrl('admin/region/node'); ?>" data-code-url="<?php echo MyUrl('admin/region/codedata'); ?>">
    <label class="am-block">
        <span><?php echo MyLang('form_region_title'); ?></span>
        <?php if(isset($is_force_region_choice) and $is_force_region_choice == 1): ?><span class="am-form-group-label-tips-must">*</span><?php endif; ?>
        <div class="am-input-group am-input-group-sm am-fr region-linkage-code">
            <input type="text" class="am-form-field am-radius" placeholder="<?php echo MyLang('form_region_code_placeholder'); ?>" />
            <span class="am-input-group-btn">
                <button type="button" class="am-btn am-btn-default am-btn-xs am-radius"><?php echo MyLang('form_region_code_button_name'); ?></button>
            </span>
        </div>
    </label>
    <select name="province" data-next="city" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('form_region_province_title'); ?>" data-validation-message="<?php echo MyLang('form_region_province_message'); ?>" data-value="<?php if(isset($data['province'])): ?><?php echo htmlentities($data['province']); else: ?>0<?php endif; ?>" <?php if(isset($is_force_region_choice) and $is_force_region_choice == 1): ?>required<?php endif; ?>>
        <option value=""><?php echo MyLang('form_region_province_title'); ?></option>
    </select>
    <select name="city" data-next="county" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('form_region_city_title'); ?>" data-validation-message="<?php echo MyLang('form_region_city_message'); ?>" data-value="<?php if(isset($data['city'])): ?><?php echo htmlentities($data['city']); else: ?>0<?php endif; ?>" <?php if(isset($is_force_region_choice) and $is_force_region_choice == 1): ?>required<?php endif; ?>>
        <option value=""><?php echo MyLang('form_region_city_title'); ?></option>
    </select>
    <select name="county" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('form_region_county_title'); ?>" data-validation-message="<?php echo MyLang('form_region_county_message'); ?>" data-value="<?php if(isset($data['county'])): ?><?php echo htmlentities($data['county']); else: ?>0<?php endif; ?>">
        <option value=""><?php echo MyLang('form_region_county_title'); ?></option>
    </select>
</div>
                <div class="am-form-group">
                    <label class="am-block"><?php echo MyLang('site.form_take_address_address'); ?><span class="am-form-group-label-tips-must">*</span></label>
                    <input type="hidden" name="lng" id="form-lng" />
                    <input type="hidden" name="lat" id="form-lat" />
                    <div class="am-input-group am-input-group-sm">
                        <input type="text" name="address" id="form-address" placeholder="<?php echo MyLang('site.form_take_address_address'); ?>" minlength="2" maxlength="80" data-validation-message="<?php echo MyLang('site.form_take_address_address_message'); ?>" class="am-radius am-form-field" required />
                        <span class="am-input-group-btn">
                            <button class="am-btn am-btn-default am-radius" type="button" id="map-location-submit">
                                <i class="am-icon-map-marker"></i>
                                <span><?php echo MyLang('location_title'); ?></span>
                            </button>
                        </span>
                    </div>
                ...
                <div class="am-form-popup-submit">
                    ...
                    <button type="submit" class="am-btn am-btn-primary am-radius am-btn-xs btn-loading-example" data-am-loading="{spinner: 'circle-o-notch', loadingText:'<?php echo MyLang('confirm_title'); ?>'}">
