<?php /*a:4:{s:65:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/seo/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<div class="am-alert am-alert-warning am-radius am-margin-bottom-0" data-am-alert>
		    ...
		    <p class="am-text-xs"><?php echo MyLang('seo.top_tips'); if(!empty($site_store_links) and !empty($site_store_links['htaccess_set_course'])): ?><a href="<?php echo htmlentities($site_store_links['htaccess_set_course']); ?>" class="am-margin-left-sm" target="_blank"><?php echo MyLang('view_config_course_name'); ?> <i class="am-icon-external-link"></i></a><?php endif; ?></p>
		</div>

		<!-- form start -->
		<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/seo/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/seo/index'); ?>">
			<div class="am-form-group">
				...
				<select name="<?php echo htmlentities($data['home_seo_url_model']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_seo_url_model']['error_tips']); ?>" required>
					<?php foreach($common_seo_url_model_list as $v): ?>
