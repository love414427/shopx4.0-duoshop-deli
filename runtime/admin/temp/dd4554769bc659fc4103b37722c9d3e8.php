<?php /*a:5:{s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/agreement/register.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/agreement/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="content">
        ...
        <form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/agreement/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/agreement/index', ['nav_type'=>$nav_type]); ?>">
            <div class="am-form-group">
                <div class="am-cf">
                    <label><span class="am-form-group-label-tips am-margin-left-0"><?php echo htmlentities($data['common_agreement_userregister']['describe']); ?></span></label>
                    <a href="<?php echo MyUrl('index/agreement/index', ['document'=>'userregister']); ?>" target="_blank" class="am-fr"><?php echo MyLang('agreement.view_detail_name'); ?></a>
                </div>
            ...
            <div class="am-form-popup-submit">
                <a href="<?php echo MyUrl('index/agreement/index', ['document'=>'userregister']); ?>" class="am-btn am-btn-default am-radius am-btn-xs am-margin-right-lg" target="_blank">
