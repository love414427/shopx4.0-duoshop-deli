<?php /*a:6:{s:73:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/article/save_info.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:63:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/seo.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation am-form-full-screen am-form-popup-fixed" action="<?php echo MyUrl('admin/article/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/article/index', $params); ?>">
			<legend>
				<span class="am-text-default"><?php echo MyLang('article.base_nav_title'); if(empty($data['id'])): ?><?php echo MyLang('created_title'); else: ?><?php echo MyLang('edit_title'); ?><?php endif; ?></span>
				<a href="<?php echo MyUrl('admin/article/index', $params); ?>" class="am-fr am-text-sm am-margin-top-sm am-icon-mail-reply"> <?php echo MyLang('retreat_title'); ?></a>
			</legend>
			<div class="am-cf">
        		<div class="am-u-sm-6 am-padding-horizontal-0">
					<div class="am-form-group">
						<label><?php echo MyLang('common_service.article.form_item_title'); ?><span class="am-form-group-label-tips-must">*</span></label>
						...
						<div class="am-input-group am-input-group-sm">
							<input type="text" name="title" placeholder="<?php echo MyLang('common_service.article.form_item_title_message'); ?>" minlength="2" maxlength="60" data-validation-message="<?php echo MyLang('common_service.article.form_item_title_message'); ?>" class="am-form-field am-radius" <?php if(!empty($data['title'])): ?> value="<?php echo htmlentities($data['title']); ?>" <?php endif; if(!empty($data['title_color'])): ?> style="color:<?php echo htmlentities($data['title_color']); ?>;" <?php endif; ?> required />
				...
				<div class="am-u-sm-6 am-padding-horizontal-0">
					<div class="am-form-group">
						<label><?php echo MyLang('common_service.article.form_item_article_category'); ?><span class="am-form-group-label-tips-must">*</span></label>
						<select name="article_category_id" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('optional_tips'); ?>" data-validation-message="<?php echo MyLang('common_service.article.form_item_article_category_message'); ?>" required>
							<option value=""><?php echo MyLang('optional_tips'); ?></option>
							<?php foreach($article_category_list as $v): ?>
								<option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['article_category_id']) and $data['article_category_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
			...
			<div class="am-cf">
        		<div class="am-u-md-6 am-padding-horizontal-0">
        			<div class="am-form-group">
						<label><?php echo MyLang('common_service.article.form_item_jump_url_title'); ?><a href="javascript:;" class="am-icon-question-circle am-text-warning am-margin-left-sm" data-am-popover="{content: '<?php echo MyLang('common_service.article.form_item_jump_url_tips'); ?>', trigger: 'hover focus', theme: 'sm'}"></a></label>
						<input type="url" name="jump_url" placeholder="<?php echo MyLang('common_service.article.form_item_jump_url_title'); ?>" data-validation-message="<?php echo MyLang('common_service.article.form_item_jump_url_message'); ?>" class="am-radius" <?php if(!empty($data['jump_url'])): ?> value="<?php echo htmlentities($data['jump_url']); ?>"<?php endif; ?> />
					</div>
        		</div>
        		<div class="am-u-md-6 am-padding-horizontal-0">
        			<div class="am-cf">
...
<!-- 是否启用 结束 -->
        				...
        				<div class="am-u-sm-6 am-padding-horizontal-0">
        					<div class="am-form-group">
							    <label class="am-block"><?php echo MyLang('common_service.article.form_item_is_home_recommended_title'); ?></label>
							    <input name="is_home_recommended" value="1" type="checkbox" data-off-text="<?php echo MyLang('no_title'); ?>" data-on-text="<?php echo MyLang('yes_title'); ?>" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if(isset($data['is_home_recommended']) and $data['is_home_recommended'] == 1): ?>checked="true"<?php endif; ?> />
							</div>
        				</div>
        			</div>
        		</div>
			...
			<div class="am-form-group">
				<label><?php echo MyLang('common_service.article.form_item_content_title'); ?><span class="am-form-group-label-tips-must">*</span></label>
				<textarea class="am-radius am-validate" name="content" rows="5" minlength="10" maxlength="105000" <?php if(!IsMobile()): ?>id="editor-tag" data-url="<?php echo MyUrl('admin/ueditor/index', ['path_type'=>'article']); ?>" placeholder="<?php echo MyLang('common_service.article.form_item_content_message'); ?>" <?php else: ?> placeholder="<?php echo MyLang('common_service.article.form_item_content_placeholder'); ?>" <?php endif; ?> data-validation-message="<?php echo MyLang('common_service.article.form_item_content_message'); ?>" required><?php if(!empty($data['content'])): ?><?php echo htmlentities($data['content']); ?><?php endif; ?></textarea>
			</div>
            ...
            <?php endif; if(!empty($plugins_view_admin_article_save_data) and is_array($plugins_view_admin_article_save_data)): ?>
				<div class="am-alert am-alert-secondary">
					<label class="am-text-sm am-text-warning"><?php echo MyLang('plugins_view_region_config_tips'); ?></label>
					<div>
						<?php foreach($plugins_view_admin_article_save_data as $hook): if(is_string($hook) or is_int($hook)): ?>
		                        <?php echo $hook; ?>
		                    <?php endif; ?>
		                <?php endforeach; ?>
					</div>
    ...
    <div class="am-u-sm-12 am-u-md-4 am-padding-horizontal-0">
        <div class="am-form-group">
			...
			<div class="am-form-popup-submit">
				...
				<a href="<?php echo MyUrl('admin/article/index', $params); ?>" class="am-btn am-btn-warning am-radius am-btn-xs am-margin-right-lg">
