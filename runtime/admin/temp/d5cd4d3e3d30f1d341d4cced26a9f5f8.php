<?php /*a:4:{s:68:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/config/store.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/config/save', ['view_type'=>$view_type]); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/config/store'); ?>">
            ...
            <div class="am-form-group">
                <label class="am-block"><?php echo htmlentities($data['common_customer_store_qrcode']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_customer_store_qrcode']['describe']); ?></span></label>
                <ul class="plug-file-upload-view common_customer_store_qrcode-images-view" data-form-name="common_customer_store_qrcode" data-max-number="1" data-dialog-type="images">
                    <?php if(!empty($data['common_customer_store_qrcode']['value'])): ?>
                        <li>
                            ...
                            <img src="<?php echo AttachmentPathViewHandle($data['common_customer_store_qrcode']['value']); ?>" />
                            <i>×</i>
                        </li>
                    <?php endif; ?>
                </ul>
                <div class="plug-file-upload-submit" data-view-tag="ul.common_customer_store_qrcode-images-view">+<?php echo MyLang('form_choice_images_title'); ?></div>
            </div>
