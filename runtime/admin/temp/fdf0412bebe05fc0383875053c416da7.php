<?php /*a:6:{s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/siteset/order.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:79:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/siteset_nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>$nav_type, 'view_type'=>$view_type]); ?>" enctype="multipart/form-data">
            ...
            <div class="am-panel am-panel-default am-margin-top-sm">
                ...
                <div class="am-panel-bd am-padding-vertical-xs">
                    ...
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['common_order_is_booking']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_order_is_booking']['error_tips']); ?>" required>
                    ...
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['common_is_deduction_inventory']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_is_deduction_inventory']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                    ...
                    <div class="am-form-group">
                        ...
                        <select name="<?php echo htmlentities($data['common_deduction_inventory_rules']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_deduction_inventory_rules']['error_tips']); ?>" required>
                    ...
                    <!-- 订单商品销量 -->
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_goods_sales_count_inc_rules']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_goods_sales_count_inc_rules']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_goods_sales_count_inc_rules']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_goods_sales_count_inc_rules']['error_tips']); ?>" required>
                            <?php foreach($common_sales_count_inc_rules_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_goods_sales_count_inc_rules']['value']) and $data['common_goods_sales_count_inc_rules']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <!-- 订单支付 -->
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['home_is_enable_order_bulk_pay']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_is_enable_order_bulk_pay']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['home_is_enable_order_bulk_pay']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_is_enable_order_bulk_pay']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['home_is_enable_order_bulk_pay']['value']) and $data['home_is_enable_order_bulk_pay']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_is_pay_price_must_max_equal']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_is_pay_price_must_max_equal']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_is_pay_price_must_max_equal']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_is_pay_price_must_max_equal']['error_tips']); ?>" required>
                            <?php foreach($common_close_open_list as $v): ?>
                                <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_is_pay_price_must_max_equal']['value']) and $data['common_is_pay_price_must_max_equal']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <!-- 线下支付 -->
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_is_under_line_order_normal']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_is_under_line_order_normal']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_is_under_line_order_normal']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_is_under_line_order_normal']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_is_under_line_order_normal']['value']) and $data['common_is_under_line_order_normal']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <!-- 虚拟订单直接提交支付 -->
                    <div class="am-form-group">
                        <label><?php echo htmlentities($data['common_fictitious_order_direct_pay']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_fictitious_order_direct_pay']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_fictitious_order_direct_pay']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_fictitious_order_direct_pay']['error_tips']); ?>" required>
                            <?php foreach($common_is_text_list as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_fictitious_order_direct_pay']['value']) and $data['common_fictitious_order_direct_pay']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="am-panel am-panel-default am-margin-top-sm">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('site.base_item_default_payment_title'); ?></h3>
                </div>
                <div class="am-panel-bd">
                    <div class="business-form-group am-padding-vertical-0 platform-list-value-container">
                        <p class="am-text-warning"><?php echo MyLang('site.site_setup_order_default_payment_tips'); ?></p>
                        <?php foreach($common_platform_type as $v): ?>
                            <div class="am-input-group am-input-group-sm">
                                ...
                                <select name="common_default_payment[<?php echo htmlentities($v['value']); ?>]" class="am-radius chosen-select" data-placeholder="<?php echo MyLang('optional_tips'); ?>" data-validation-message="<?php echo MyLang('site.site_setup_choice_payment_message', ['name'=>$v['name']]); ?>">
                                    <option value=""><?php echo MyLang('optional_tips'); ?></option>
                                    <?php if(!empty($payment_list)): foreach($payment_list as $pay): if(!empty($pay['apply_terminal']) and is_array($pay['apply_terminal']) and in_array($v['value'], $pay['apply_terminal'])): ?>
                                                <option value="<?php echo htmlentities($pay['payment']); ?>" <?php if(!empty($data['common_default_payment']) and !empty($data['common_default_payment']['value']) and !empty($data['common_default_payment']['value'][$v['value']]) and $data['common_default_payment']['value'][$v['value']] == $pay['payment']): ?>selected<?php endif; ?>><?php echo htmlentities($pay['name']); ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
