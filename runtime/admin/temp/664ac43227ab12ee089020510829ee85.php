<?php /*a:16:{s:66:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/link/index.html";i:1699863362;s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:86:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_top.html";i:1699863362;s:80:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table.html";i:1699863362;s:87:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_search.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_content.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/not_data.html";i:1699863362;s:89:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_operate_bottom.html";i:1699863362;s:88:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_fields_select.html";i:1699863362;s:85:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/module/form_table_page.html";i:1699863362;s:64:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/sort.html";i:1699863362;s:78:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_new_window_open.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/lib/is_enable.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-form-table-data-container content-right">
    ...
    <button type="button" class="am-btn am-btn-secondary am-radius am-btn-xs am-icon-plus submit-add" data-am-modal="{target: '#data-save-win'}"> <?php echo MyLang('add_title'); ?></button>
    <!-- 父级内容 -->
...
<?php if(!empty($form_table_data_list) and !empty($form_table['base']['key_field'])): ?>
    <!-- 处理数据数量小于默认数量 -->
    <?php $__FOR_START_1416127291__=0;$__FOR_END_1416127291__=count($form_table_data_list);for($i=$__FOR_START_1416127291__;$i < $__FOR_END_1416127291__;$i+=1){ ?>
        <!-- 1. tr 主键id名称 -->
        <!-- 2. 是否黄色选中class -->
        <tr
                                    ...
                                    <?php endif; break; case "star": 
                                     ...
                                     if(!empty($t[$temp_star_data_key_field]) and isset($form_table_data_list[$i][$t[$temp_star_data_key_field]])): ?>
                                        <div class="am-text-grey am-inline-block am-vertical-align-middle">
                                            <?php $__FOR_START_331427941__=1;$__FOR_END_331427941__=empty($t['star_max']) ? 5 : $t['star_max'];for($star_i=$__FOR_START_331427941__;$star_i <= $__FOR_END_331427941__;$star_i+=1){ if($star_i > $form_table_data_list[$i][$t[$temp_star_data_key_field]]): ?>
	...
	<div class="am-popup am-radius" id="data-save-win">
		<div class="am-popup-inner">
			<div class="am-popup-hd">
				<h4 class="am-popup-title" data-add-title="<?php echo MyLang('link.base_nav_title'); ?><?php echo MyLang('add_title'); ?>" data-edit-title="<?php echo MyLang('link.base_nav_title'); ?><?php echo MyLang('edit_title'); ?>"><?php echo MyLang('link.base_nav_title'); ?><?php echo MyLang('add_title'); ?></h4>
				<span data-am-modal-close class="am-close">&times;</span>
			</div>
			<div class="am-popup-bd">
				<!-- form start -->
				<form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/link/Save'); ?>" method="POST" request-type="ajax-reload" request-value="">
					<div class="am-form-group">
						<label><?php echo MyLang('common_service.link.form_item_name'); ?><span class="am-form-group-label-tips-must">*</span></label>
						<input type="text" placeholder="<?php echo MyLang('common_service.link.form_item_name_message'); ?>" name="name" minlength="1" maxlength="60" data-validation-message="<?php echo MyLang('common_service.link.form_item_name_message'); ?>" class="am-radius" required />
					</div>
					<div class="am-form-group">
						<label><?php echo MyLang('common_service.link.form_item_url'); ?><span class="am-form-group-label-tips-must">*</span></label>
						<input type="url" placeholder="<?php echo MyLang('common_service.link.form_item_url_placeholder'); ?>" name="url" data-validation-message="<?php echo MyLang('common_service.link.form_item_url_message'); ?>" class="am-radius" required />
					</div>
					<!-- 排序 开始 -->
<div class="am-form-group">
...
<!-- 是否启用 结束 -->
					<div class="am-form-group am-form-success">
						<label><?php echo MyLang('common_service.link.form_item_desc'); ?></label>
						<textarea rows="3" maxlength="60" name="describe" class="am-radius" placeholder="<?php echo MyLang('common_service.link.form_item_desc_message'); ?>" data-validation-message="<?php echo MyLang('common_service.link.form_item_desc_message'); ?>"></textarea>
					</div>
					<div class="am-form-popup-submit">
