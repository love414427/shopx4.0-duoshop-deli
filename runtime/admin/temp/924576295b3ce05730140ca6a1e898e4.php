<?php /*a:6:{s:74:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/siteset/goods.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:79:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/siteset_nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>$nav_type, 'view_type'=>$view_type]); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['common_is_goods_detail_show_photo']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_is_goods_detail_show_photo']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['common_is_goods_detail_show_photo']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_is_goods_detail_show_photo']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_is_goods_detail_show_photo']['value']) and $data['common_is_goods_detail_show_photo']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['common_is_show_goods_comments']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_is_show_goods_comments']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['common_is_show_goods_comments']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_is_show_goods_comments']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_is_show_goods_comments']['value']) and $data['common_is_show_goods_comments']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['common_show_goods_category_level']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_show_goods_category_level']['describe']); ?></span></label>
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" max="3" name="<?php echo htmlentities($data['common_show_goods_category_level']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_show_goods_category_level']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_show_goods_category_level']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_show_goods_category_level']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius"><?php echo MyLang('level_title'); ?></span>
                </div>
                <?php if(is_array(MyLang('site.goods_tips_list'))): ?>
                    <div class="am-alert am-alert-warning" data-am-alert>
                        <button type="button" class="am-close">&times;</button>
                        <p><?php echo implode('</p><p>', MyLang('site.goods_tips_list')); ?></p>
                    </div>
                <?php endif; ?>
            </div>
