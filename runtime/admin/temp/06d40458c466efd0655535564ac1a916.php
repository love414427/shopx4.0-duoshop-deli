<?php /*a:5:{s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/appconfig/app.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/appconfig/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <ul class="am-nav am-nav-pills table-nav second-nav">
        <?php foreach($nav_data as $v): ?>
            <li <?php if($nav_type == $v['type']): ?>class="am-active"<?php endif; ?> data-type="<?php echo htmlentities($v['type']); ?>">
                <a href="<?php echo MyUrl('admin/appconfig/index', ['nav_type'=>$v['type']]); ?>"><?php echo htmlentities($v['name']); ?></a>
            </li>
        <?php endforeach; ?>
    </ul>
<?php endif; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/appconfig/save', ['nav_type'=>$nav_type]); ?>" method="POST" request-type="ajax-reload">
            <!-- 基础配置 -->
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('base_config_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_is_use_mobile_detail']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_is_use_mobile_detail']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_app_is_use_mobile_detail']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_app_is_use_mobile_detail']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_is_text_list') as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_app_is_use_mobile_detail']['value']) and $data['common_app_is_use_mobile_detail']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_user_is_mandatory_bind_mobile']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_user_is_mandatory_bind_mobile']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_user_is_mandatory_bind_mobile']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_user_is_mandatory_bind_mobile']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_is_text_list') as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_user_is_mandatory_bind_mobile']['value']) and $data['common_user_is_mandatory_bind_mobile']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_user_onekey_bind_mobile_list']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_user_onekey_bind_mobile_list']['describe']); ?></span></label>
                        <?php foreach(MyConst('common_platform_type') as $v): if(in_array($v['value'], ['weixin', 'baidu', 'toutiao'])): ?>
                                <label class="am-checkbox-inline">
                                    <input type="checkbox" name="<?php echo htmlentities($data['common_user_onekey_bind_mobile_list']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_user_onekey_bind_mobile_list']['value']) and in_array($v['value'], $data['common_user_onekey_bind_mobile_list']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['common_user_onekey_bind_mobile_list']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                                </label>
                            <?php endif; ?>
                        <?php endforeach; if(is_array(MyLang('appconfig.user_onekey_bind_mobile_tips_list'))): ?>
                            <div class="am-alert am-alert-warning" data-am-alert>
                                <button type="button" class="am-close">&times;</button>
                                <p><?php echo implode('</p><p>', MyLang('appconfig.user_onekey_bind_mobile_tips_list')); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_user_address_platform_import_list']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_user_address_platform_import_list']['describe']); ?></span></label>
                        <?php foreach(MyConst('common_platform_type') as $v): if(in_array($v['value'], ['weixin', 'baidu', 'alipay', 'qq', 'toutiao'])): ?>
                                <label class="am-checkbox-inline">
                                    <input type="checkbox" name="<?php echo htmlentities($data['common_user_address_platform_import_list']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_user_address_platform_import_list']['value']) and in_array($v['value'], $data['common_user_address_platform_import_list']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['common_user_address_platform_import_list']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                                </label>
                            <?php endif; ?>
                        <?php endforeach; if(is_array(MyLang('appconfig.user_address_platform_import_tips_list'))): ?>
                            <div class="am-alert am-alert-warning" data-am-alert>
                                <button type="button" class="am-close">&times;</button>
                                <p><?php echo implode('</p><p>', MyLang('appconfig.user_address_platform_import_tips_list')); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_is_enable_search']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_is_enable_search']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_app_is_enable_search']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_app_is_enable_search']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_is_text_list') as $v): ?>
                    ...
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_is_header_nav_fixed']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_is_header_nav_fixed']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_app_is_header_nav_fixed']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_app_is_header_nav_fixed']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_is_text_list') as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_app_is_header_nav_fixed']['value']) and $data['common_app_is_header_nav_fixed']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_is_online_service']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_is_online_service']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_app_is_online_service']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_app_is_online_service']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_is_text_list') as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_app_is_online_service']['value']) and $data['common_app_is_online_service']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_is_head_vice_nav']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_is_head_vice_nav']['describe']); ?></span></label>
                        <select name="<?php echo htmlentities($data['common_app_is_head_vice_nav']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['common_app_is_head_vice_nav']['error_tips']); ?>" required>
                            <?php foreach(MyConst('common_is_text_list') as $v): ?>
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_app_is_head_vice_nav']['value']) and $data['common_app_is_head_vice_nav']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="am-panel am-panel-default am-radius">
                <div class="am-panel-hd">
                    <h3 class="am-panel-title"><?php echo MyLang('appconfig.user_base_popup_title'); ?></h3>
                </div>
                <div class="am-panel-bd am-padding-vertical-xs">
                    <?php if(is_array(MyLang('appconfig.user_base_popup_top_tips_list'))): ?>
                        <div class="am-alert am-alert-warning am-margin-top-sm" data-am-alert>
                            <button type="button" class="am-close">&times;</button>
                            <p><?php echo implode('</p><p>', MyLang('appconfig.user_base_popup_top_tips_list')); ?></p>
                        </div>
                    <?php endif; ?>
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_user_base_popup_pages']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_user_base_popup_pages']['describe']); ?></span></label>
                        <?php foreach(MyConst('common_user_base_popup_pages_list') as $v): ?>
                            <label class="am-checkbox-inline">
                                <input type="checkbox" name="<?php echo htmlentities($data['common_app_user_base_popup_pages']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_app_user_base_popup_pages']['value']) and in_array($v['value'], $data['common_app_user_base_popup_pages']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['common_app_user_base_popup_pages']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                            </label>
                        <?php endforeach; ?>
                    </div>
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_user_base_popup_client']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_user_base_popup_client']['describe']); ?></span></label>
                        <?php foreach(MyConst('common_platform_type') as $v): if(!in_array($v['value'], ['pc'])): ?>
                                <label class="am-checkbox-inline">
                                    <input type="checkbox" name="<?php echo htmlentities($data['common_app_user_base_popup_client']['only_tag']); ?>" value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['common_app_user_base_popup_client']['value']) and in_array($v['value'], $data['common_app_user_base_popup_client']['value'])): ?>checked<?php endif; ?> data-validation-message="<?php echo htmlentities($data['common_app_user_base_popup_client']['error_tips']); ?>" data-am-ucheck /> <?php echo htmlentities($v['name']); ?>
                                </label>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
                    <div class="am-form-group">
                        <label class="am-block"><?php echo htmlentities($data['common_app_user_base_popup_interval_time']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_app_user_base_popup_interval_time']['describe']); ?></span></label>
                        <div class="am-input-group am-input-group-sm">
                            ...
                            <span class="am-input-group-btn">
                                <button class="am-btn am-btn-default" type="button"><?php echo MyLang('second_title'); ?></button>
                          </span>
                        </div>
                    </div>
                </div>
