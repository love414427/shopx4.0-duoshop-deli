	...
	<div class="content">
		...
		<?php foreach($cache_type_list as $v): if($v['is_enable'] == 1): ?>
				<div class="am-panel am-panel-default am-radius">
					...
					<a href="javascript:;" class="submit-ajax" data-url="<?php echo htmlentities($v['url']); ?>" data-is-confirm="0">
						<button type="button" class="am-btn am-btn-secondary am-radius am-btn-xs am-fr cache-submit"><?php echo MyLang('update_title'); ?></button>
					</a>
