<?php /*a:5:{s:81:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/orderaftersale/index.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/header.html";i:1699863362;s:75:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/page_loading.html";i:1699863362;s:71:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/site/public/nav.html";i:1699863362;s:69:"/www/wwwroot/v4.shop.iun.cc/app/admin/view/default/public/footer.html";i:1699863362;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endswitch; ?>
    ...
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation am-form-popup-fixed" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'orderaftersale']); ?>" enctype="multipart/form-data">
            ...
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_name']['name']); ?></label>
                <input type="text" name="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_name']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_name']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_name']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_name']['value']); ?>"<?php endif; ?> />
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_tel']['name']); ?></label>
                <input type="text" name="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_tel']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_tel']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_tel']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_order_aftersale_return_goods_contacts_tel']['value']); ?>"<?php endif; ?> />
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_goods_address']['name']); ?></label>
            ...
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_is_use_warehouse_address']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_order_aftersale_is_use_warehouse_address']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_order_aftersale_is_use_warehouse_address']['only_tag']); ?>" class="am-radius chosen-select" data-validation-message="<?php echo htmlentities($data['home_order_aftersale_is_use_warehouse_address']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['home_order_aftersale_is_use_warehouse_address']['value']) and $data['home_order_aftersale_is_use_warehouse_address']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_launch_day']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_order_aftersale_return_launch_day']['describe']); ?></span></label>
                <div class="am-input-group am-input-group-sm">
                    <input type="number" min="0" name="<?php echo htmlentities($data['home_order_aftersale_return_launch_day']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_order_aftersale_return_launch_day']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_order_aftersale_return_launch_day']['error_tips']); ?>" class="am-radius am-form-field" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_order_aftersale_return_launch_day']['value']); ?>"<?php endif; ?> />
                    <span class="am-input-group-label am-radius"><?php echo MyLang('day_title'); ?></span>
                </div>
            </div>
